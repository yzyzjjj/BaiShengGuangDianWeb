function pageReady(){document.documentElement.style.fontSize=document.documentElement.clientWidth/768*100+"px";$(".ms2").select2();getDevice();$("#chartTypeSelect").on("change",()=>$("#chartTypeSelect").val()==0?$("#chartSelect").addClass("hidden"):$("#chartSelect").removeClass("hidden"));$("#selectCodeHistory").on("select2:select",()=>{getHistoryScript(),$("#tableChart,#chartSelect").empty(),_tableType={},_flag=0,$("#tableChart").off("resize")});$("#historyPage").one("click",()=>getHistoryScript());var n=getHourAgo().split(" "),t=getFullTime().split(" ");$("#sDate").val(n[0]).datepicker("update");$("#sTime").timepicker("setTime",n[1]);$("#eDate").val(t[0]).datepicker("update");$("#eTime").timepicker("setTime",t[1]);$(window).on("scroll",()=>$(document).scrollTop()>900?$("#backTop").fadeIn():$("#backTop").fadeOut());$("#backTop").on("click",()=>{$("html,body").stop().animate({scrollTop:0})});let i=0;$("#kanBanData").on("resize",()=>{clearTimeout(i),i=setTimeout(()=>{echarts.init($("#chartmain")[0]).resize(),echarts.init($("#chartmain_bing")[0]).resize(),echarts.init($("#chartmain_zhe")[0]).resize()},200)})}function dataTableSearch(n){var u=_dataTableData[n],i=$(this).parent(),t=i.find(".val").val().trim(),r,f;u.columns([0,1,2,3]).search("").draw();isStrEmptyOrUndefined(t)||(r=i.find(".sym").val(),r==0?t=`^${t}$`:r==1&&(t=`^(?!${t}$).+$`),f=i.find(".thText").val(),u.columns(f).search(t,!0,!1).draw())}function getDevice(){var n={};n.opType=100;n.opData=JSON.stringify({detail:!0});ajaxPost("/Relay/Post",n,function(n){var i,f,u,r,t;if(n.errno!=0){layer.msg(n.errmsg);return}for(_codeData={},i=n.datas,i.sort((n,t)=>n.Code-t.Code),f='<option value="{0}" script="{1}">{2}<\/option>',u="",r=0;r<i.length;r++)t=i[r],_codeData[t.Id]=t,u+=f.format(t.Id,t.ScriptId,t.Code);$("#selectCode,#selectCodeHistory").empty().append(u);getCodeDetail()})}function getCodeDetail(){var t,n;if($("#script").text(_codeData[$("#selectCode").val()].ScriptName),t=$("#selectCode :selected").attr("script"),isStrEmptyOrUndefined(t)){layer.msg("请选择设备");return}n={};n.opType=106;n.opData=JSON.stringify({sId:t});ajaxPost("/Relay/Post",n,function(n){var i,t,u,r;if(n.errno!=0){layer.msg(n.errmsg);return}for(i=n.datas,_codeDetailObj={1:[],2:[],3:[]},t=0,u=i.length;t<u;t++)r=i[t],_codeDetailObj[r.VariableTypeId].push(r);getScriptValue()})}function getScriptValue(){var t=$("#selectCode").val(),n;if(isStrEmptyOrUndefined(t)){layer.msg("请选择设备");return}n={};n.opType=109;n.opData=JSON.stringify({all:!0,qId:t});ajaxPost("/Relay/Post",n,function(n){var i,r,u,o;if(n.errno!=0){layer.msg(n.errmsg);return}var f=n.datas[0]||[],s=f.vals||[],h=f.ins||[],c=f.outs||[],e=(n,t,i,r,u)=>toNonExponential(n[u.row]),t=$.extend(!0,{},_tablesConfig);t.iDisplayLength=20;t.columns[3]={data:null,title:"值"};i=$.extend(!0,{},t);i.data=_codeDetailObj[1];i.columns[3].render=e.bind(null,s);_dataTableData.valList=$("#valList").DataTable(i);r=$.extend(!0,{},t);r.data=_codeDetailObj[2];r.columns[3].render=e.bind(null,h);_dataTableData.insList=$("#insList").DataTable(r);u=$.extend(!0,{},t);u.data=_codeDetailObj[3];u.columns[3].render=e.bind(null,c);_dataTableData.outList=$("#outList").DataTable(u);o=$("#realQuery .val");o.each((n,t)=>{isStrEmptyOrUndefined(t.value)||t.oninput()})})}function getHistoryScript(){var i=$("#selectCodeHistory").val(),t,n;if(!isStrEmptyOrUndefined(i)){if($("#historyScript").text(_codeData[i].ScriptName),t=$("#selectCodeHistory :selected").attr("script"),isStrEmptyOrUndefined(t)){layer.msg("请选择设备");return}n={};n.opType=106;n.opData=JSON.stringify({sId:t});ajaxPost("/Relay/Post",n,function(n){var h,i,u,c,r,l,f,t,e,o,s;if(n.errno!=0){layer.msg(n.errmsg);return}for(h=n.datas,i={1:[],2:[],3:[]},_historyData={},u=0,c=h.length;u<c;u++)r=h[u],l=r.VariableTypeId,i[l].push(r),_historyData[r.Id]=r;f=(n,t)=>`<button type="button" class="btn btn-success btn-xs" onclick="addVar('${n}',${t.Id})"><i class="fa fa-plus"></i></button>`;t=$.extend(!0,{},_tablesConfig);t.iDisplayLength=10;t.columns[3]={data:null,title:"添加",orderable:!1};e=$.extend(!0,{},t);e.data=i[1];e.columns[3].render=f.bind(null,"vals");_dataTableData.historyValList=$("#historyValList").DataTable(e);o=$.extend(!0,{},t);o.data=i[2];o.columns[3].render=f.bind(null,"ins");_dataTableData.historyInsList=$("#historyInsList").DataTable(o);s=$.extend(!0,{},t);s.data=i[3];s.columns[3].render=f.bind(null,"outs");_dataTableData.historyOutList=$("#historyOutList").DataTable(s)})}}function getHistoryData(){var s=$("#selectCodeHistory").val(),n,o,t,i,e,r;if(isStrEmptyOrUndefined(s)){layer.msg("请选择设备");return}var h=$("#sDate").val().trim(),u=$("#sTime").val().trim(),c=$("#eDate").val().trim(),f=$("#eTime").val().trim();if(isStrEmptyOrUndefined(h)||isStrEmptyOrUndefined(u)||isStrEmptyOrUndefined(c)||isStrEmptyOrUndefined(f)){layer.msg("请选择时间");return}if(u=`${h} ${u}`,f=`${c} ${f}`,compareDate(u,f)){layer.msg("开始时间不能大于结束时间");return}if(new Date(f)-new Date(u)>36e5){layer.msg("时间不能超过一小时");return}for(n={vals:[],ins:[],outs:[]},o=Object.values(_tableType).flat(),i=0,e=o.length;i<e;i++){const t=o[i];switch(t.VariableTypeId){case 1:n.vals.push(t.PointerAddress);break;case 2:n.ins.push(t.PointerAddress);break;case 3:n.outs.push(t.PointerAddress)}}for(t in n)n[t]=[...new Set(n[t])];if(!n.vals.length&&!n.ins.length&&!n.outs.length){layer.msg("请先添加地址");return}r={};r.opType=507;r.opData=JSON.stringify({StartTime:u,EndTime:f,DeviceId:s,DeviceData:n});ajaxPost("/Relay/Post",r,function(u){var o,s,l,a;if(u.errno!=0){layer.msg(u.errmsg);return}var h=u.data,c=[],f={};for(t in h){c.push(t.replace(" ","\n"));const i=h[t];$.each(n.vals,(n,t)=>{f[`vals${t}`]?f[t].push(i.vals[n]):f[t]=[i.vals[n]]});$.each(n.ins,(n,t)=>{f[`ins${t}`]?f[t].push(i.ins[n]):f[t]=[i.ins[n]]});$.each(n.outs,(n,t)=>{f[`outs${t}`]?f[t].push(i.outs[n]):f[t]=[i.outs[n]]})}for(t in _tableType){for(r=_tableType[t],o=[],s=[],i=0,e=r.length;i<e;i++){const t=r[i],u=t.VariableName;o.push(u);let n="";switch(t.VariableTypeId){case 1:n="vals";break;case 2:n="ins";break;case 3:n="outs"}s.push({name:u,type:"line",data:f[`${n}${t.PointerAddress}`],showSymbol:!1,sampling:"average",showAllSymbol:!1})}l={tooltip:{trigger:"axis"},grid:{left:"3%",right:"3%",top:"6%",bottom:"8%",containLabel:!0},legend:{data:o},xAxis:{type:"category",data:c},yAxis:{type:"value"},series:s,dataZoom:[{type:"slider",start:0,end:20,bottom:0},{type:"inside",start:0,end:20}],toolbox:{top:20,left:"center",feature:{dataZoom:{yAxisIndex:"none"},restore:{}}}};echarts.init($(`#${t}_chart`)[0]).setOption(l,!0)}a=()=>{var n=new Date;return()=>{var t=new Date,i;if(t-n>=200){for(i in _tableType)echarts.init($(`#${i}_chart`)[0]).resize();n=t}}};$("#tableChart").off("resize").on("resize",a())})}function addVar(n,t){var o=`<div class="flexStyle box-header" style="justify-content: flex-end">
                    ...
                    </div>`,f='<tr><td class="num">1<\/td><td class="name">{0}<\/td><td class="res">{4}<\/td><td><button type="button" class="btn btn-danger btn-xs" onclick="delVarTr.call(this,{1},\'{2}\',\'{3}\')"><i class="fa fa-minus"><\/i><\/button><\/td><\/tr>',r,s=$("#chartTypeSelect").val(),i=_historyData[t],e,u;switch(s){case"0":firstChart(`table${_flag+1}`,i,o,f,n);_flag!=1&&$("#chartSelect").append(`<option value=${_flag}>表${_flag}</option>`);break;case"1":e=$("#chartSelect").val();isStrEmptyOrUndefined(e)?layer.msg("目前未存在相关表"):(r=`table${e}`,u=_tableType[r],u?u.includes(i)?layer.msg(`${$("#chartSelect :selected").text()}已存在名称：<span style="font-weight:bold">${i.VariableName}</span>`):(u.push(i),$(`#${r}_${n}_tbody`).append(f.format(i.VariableName,i.Id,n,r,i.PointerAddress)),setNumTotalOrder(`${r}_${n}_tbody`),$(`#${r}_${n}_li`).removeClass("hidden")):firstChart(r,i,o,f,n))}}function firstChart(n,t,i,r,u){_flag++;var f=`<div class="box box-success {0}">
