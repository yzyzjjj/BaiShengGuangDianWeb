function pageReady(){var n;$(".sidebar-mini").addClass("sidebar-collapse");_permissionList[675]={uIds:[]};_permissionList[676]={uIds:["firstNavLi","setKanBan"]};_permissionList[722]={uIds:["setTab","setTabLi"]};_permissionList[723]={uIds:["carouselTab","carouselTabLi"]};_permissionList=checkPermissionUi(_permissionList);!_permissionList[722].have&&_permissionList[723].have&&$("#carouselTabLi a").click();$("#kanBanList").select2();$("#deviceSelect").select2({allowClear:!0,placeholder:"请选择",multiple:!0});$("#navUl").on("click","a",function(){var n=$(this).attr("href").replace("#",""),f=n.replace("kanBan_","");const u=parseInt(f);if(curId!=u){curId=u;let r=-1;const i=kanBans[curId];i&&(r=i.Type);timeEl=n;r==2&&$(`#${n}_deviceState`).empty();curId>-1?(dsDivs[curId]=[],dsPaths[curId]=[],page[curId]=0,setChart(n,curId,r),clearInterval(uiTime),clearInterval(dataTime),t=(i.UI<1?1:i.UI)*1e3,uiTime=setInterval(()=>{run||setChart(n,curId,r,!0)},t),t=(i.Second<1?1:i.Second)*1e3,dataTime=setInterval(()=>{run||setChart(n,curId,r)},t)):(kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))}),clearInterval(uiTime),clearInterval(dataTime))}});$(".content").on("click",".fullScreenBtn",function(){var t=`#${$(this).attr("target")}`,n;$(t).toggleClass("panel-fullscreen");n=$(t).hasClass("panel-fullscreen");$(this).toggleClass("glyphicon-fullscreen glyphicon-repeat").prop("title",n?"还原":"全屏放大");n?$(this).addClass("fsb"):$(this).removeClass("fsb");fullScreen(n);n||kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))})});setInterval(()=>{$(`#${timeEl}_time`).length>0&&$(`#${timeEl}_time`).text(getFullTime()),$(`#${carouselFlag}_time`).length>0&&$(`#${carouselFlag}_time`).text(getFullTime())},1e3);n=function(){$("#kanBanLength").val(($("#kanBanRow").val()>>0)*($("#kanBanCol").val()>>0));let n=$(this).val()>>0;n==0&&(n=1,$(this).val(n));n>15&&(n=15,$(this).val(n));const t=$("#kanBanType").val()>>0;t==3&&initColSet(!1)};$("#kanBanRow").on("input",n);$("#kanBanCol").on("input",n);$("#kanBanList").on("select2:select",function(){var t=$(this).val(),n,i,r;t&&(n=kanBans[t],$("#kanBanName").val(n.Name),$("#kanBanOrder").val(n.Order),$("#isShow").iCheck(n.IsShow?"check":"uncheck"),$("#setKanBan .stateEl").addClass("hidden"),$("#setKanBan .stateEl1").addClass("hidden"),$("#setKanBan .productEl").addClass("hidden"),$("#kanBanUI").val(n.UI),$("#kanBanSecond").val(n.Second),n.Type==2?($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#kanBanContentCol").val(n.ContentCol),$("#kanBanLength").val(n.Length),$("#setKanBan .stateEl").removeClass("hidden"),scriptIndexTmp=[],scriptTmp=[],n.ContentCol>2&&($("#kanBanItemColNameDiv").removeClass("hidden"),i=getFirstOrders(n.ContentCol),r=`（首列：${i.join()},不为空的列名）`,$("#kanBanContentColDesc").text(r),initColName(!0)),$("#kanBanScript").html("")):n.Type==3&&($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#setKanBan .productEl").removeClass("hidden"),initColSet(!0),initProduct(n.Type),showPreProduct()),$("#deviceSelect").val(n.DeviceIdList).trigger("change"))});$("#deviceSelect").on("select2:select",function(){var n=$(this).val();~n.indexOf("0")&&$(this).val(0).trigger("change")}).on("change",function(){let n=$(this).val();if(isStrEmptyOrUndefined(n)){scriptIndexTmp=[];scriptTmp=[];$("#kanBanScript").html("");return}var t=[];n.length==1&&~n.indexOf("0")&&(n=deviceTmp.map(n=>n.Id).filter(n=>n));const i=$("#kanBanType").val()>>0;i==2&&(n.forEach(n=>{if(n!=0){var i=deviceTmp[n].ScriptId;~t.indexOf(i)||t.push(i);~scriptIndexTmp.indexOf(i)?existArrayObj(scriptTmp[i].ds,"id",n)||scriptTmp[i].ds.push({id:n,code:deviceTmp[n].Code}):(scriptIndexTmp.push(i),scriptTmp[i]={sId:i,sName:deviceTmp[n].ScriptName,ds:[{id:n,code:deviceTmp[n].Code}]})}}),scriptIndexTmp=t,scriptTmp.forEach(t=>{const i=t.sId;if(~scriptIndexTmp.indexOf(i)){const t=scriptTmp[i].ds.map(n=>n.id);t.forEach(t=>{~n.indexOf(t)||removeArray(scriptTmp[i].ds,"id",t)});scriptTmp[i].ds.length==0&&delete scriptTmp[i]}else scriptTmp[i].div&&$(`#${scriptTmp[i].div}`).remove(),delete scriptTmp[i]}),getScriptList())});$("#kanBanType").on("change",function(){const n=$(this).val(),i=$(this).find(`[value=${n}]`).css("color");$(this).css("color",i);$("#setKanBan .stateEl").addClass("hidden");$("#setKanBan .productEl").addClass("hidden");const t=kanBans.filter(t=>t.Type==n&&t.Id!=0);let r=0;const u=t.reduce((t,i)=>i.Id!==0&&i.Type==n?`${t}<option value=${i.Id}>${++r}-${i.Name}</option>`:"","");if($("#kanBanList").html(u),t.length>0){const n=t[0];$("#kanBanList").val(n.Id).trigger("select2:select")}});$("#kanBanItemColSet").on("input",".kb_item_col2",function(){let n=$(this).val()>>0;const r=$(this).attr("id");let t=0;$("#kanBanItemColSet .kb_item_col2").each((n,i)=>{let u=$(i).attr("id");r!=u&&(t+=$(i).val()>>0)});const i=100-t;n>i&&(n=i,$(this).val(n));initColSet(!1)});$("#kanBanContentCol").on("input",function(){const n=$(this).val();let t="";if(n>2){var i=getFirstOrders(n);t=`（首列顺序：${i.join()}）`;$("#kanBanItemColNameDiv").removeClass("hidden");initColName(!1)}else $("#kanBanItemColNameDiv").addClass("hidden");$("#kanBanContentColDesc").text(t)});$("#kanBanScript").on("input",".order",function(){const i=$(this).closest("tr"),n=$("#kanBanContentCol").val()>>0,t=getMaxSet(n);onInput(this,5,2,1,t)});$("#kanBanScript").on("input",".subOrder",function(){const n=$(this).closest("tr");onInput(this,5,2,1,5)});$("#kanBanItems").on("click",".itemAddBtn",function(){const t=$(this),n=$(t).attr("value").trim()>>0,f=t.attr("name"),i=colSet[0].chose.length,e=$("#kanBanList").val(),r=kanBans[e],o=kanBanItems[r.Type]?kanBanItems[r.Type]:[],u=o.filter(t=>t.Item==n);if(u.length>0){const t=u[0];addOrderData(t.FieldList);kanBanItemsTmp.push({Item:n,Col:0,Order:i,Shifts:0,Hour:0,Min:0,FieldList:t.FieldList});colSet[0].chose.push({name:f,val:n,col:0,order:i,height:100,dOrder:0,dField:t.FieldList.length?t.FieldList[0].Field:""});showPreProduct()}});$("#kanBanProductDetail").on("click",".itemDelBtn",function(){const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0;var n=($(t).find(`.C_${r}`).val()>>0)-1,i=($(t).find(`.O_${r}`).val()>>0)-1;removeArray(kanBanItemsTmp,"Col",n,"Order",i);kanBanItemsTmp.forEach(t=>{t.Col==n&&t.Order>=i&&t.Order--});removeArray(colSet[n].chose,"col",n,"order",i);colSet[n].chose=colSet[n].chose.sort(sortOrder);for(let t=0,i=colSet[n].chose.length;t<i;t++)colSet[n].chose[t].order=t;showPreProduct()});$("#kanBanProductDetail").on("click",".upTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t-1,colSet[n].chose[t-1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t-1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t-1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("click",".downTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t+1,colSet[n].chose[t+1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t+1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t+1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("change",".colSet",function(){var o,i;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,r=($(n).find(`.C_${t}`).attr("old")>>0)-1,nt=($(n).find(`.O_${t}`).attr("old")>>0)-1,u=($(n).find(`.C_${t}`).val()>>0)-1,f=($(n).find(`.O_${t}`).val()>>0)-1,v=$(n).find(`.N_${t}`).val().trim(),h=$(n).find(`.H_${t}`).val(),y=$(n).find(`.DF_${t}`).val(),p=$(n).find(`.DO_${t}`).val(),e=$(n).find(`.Time_${t}`).val()>>0,w=$(n).find(`.Range_${t}`).val()>>0,b=$(n).find(`.Step_${t}`).val()>>0,k=$(n).find(`.IsSum_${t}`).is(":checked");o=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(o)&&(o=[]);const c=$(n).find(`.Shift_${t}`).val()>>0,d=$(n).find(`.Hour_${t}`).val()>>0,g=$(n).find(`.Min_${t}`).val()>>0;if(r==u)colSet[u].chose.forEach(n=>{n.order==f&&(n.name=v,n.dField=y,n.dOrder=p,n.height=isStrEmptyOrUndefined(h)?-1:h>>0)}),i=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f),kanBanItemsTmp.forEach(n=>{var t,r;n==i[0]&&(~its.indexOf(n.Item)?(n.ConfigList||(n.ConfigList=[]),t=0,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=c,n.ConfigList[t][1]=e,n.ConfigList[t][2]=w,n.ConfigList[t][3]=k?1:0,t=1,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=b,t=2,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==9&&(n.ConfigList[t]=o),t=3,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==11&&(n.ConfigList[t]=o),r="",e==0?r="hour":e==1?r="mDate":e==2?r="week":e==3?r="month":e==4&&(r="year"),n.FieldList.forEach(n=>{n.XvHao==0&&(n.Func=JSON.stringify({special:r}))})):(n.Shifts=c,n.Hour=d,n.Min=g))});else{var i=colSet[r].chose.filter(n=>n.order==f),s=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==f),l=u,a=f;i.length&&s.length&&(removeArray(colSet[r].chose,"order",f),removeArray(kanBanItemsTmp,"Col",r,"Order",f),i[0].col=u,i[0].order=colSet[u].chose.length,colSet[u].chose.push(i[0]),l=i[0].col,a=i[0].order,s[0].Col=l,s[0].Order=a,kanBanItemsTmp.push(s[0]),colSet[r].chose.forEach((n,t)=>{if(n.order!=t){var i=kanBanItemsTmp.filter(t=>t.Col==r&&t.Order==n.order);kanBanItemsTmp.forEach(n=>{n==i[0]&&(n.Order=t)});n.order=t}}))}kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("change",".ms2",function(){var i,u;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,f=($(n).find(`.C_${t}`).attr("old")>>0)-1,r=($(n).find(`.C_${t}`).val()>>0)-1,e=($(n).find(`.O_${t}`).val()>>0)-1,o=$(n).find(`.Time_${t}`).val()>>0,s=$(n).find(`.Range_${t}`).val()>>0,h=$(n).find(`.Step_${t}`).val()>>0,c=$(n).find(`.IsSum_${t}`).is(":checked");i=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(i)&&(i=[]);const l=$(n).find(`.Shift_${t}`).val()>>0;f==r&&(u=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==e),kanBanItemsTmp.forEach(n=>{if(n==u[0]){n.ConfigList||(n.ConfigList=[]);var t=0;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=l;n.ConfigList[t][1]=o;n.ConfigList[t][2]=s;n.ConfigList[t][3]=c?1:0;t=1;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=h;t=2;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==9&&(n.ConfigList[t]=i);t=3;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==11&&(n.ConfigList[t]=i)}}))});$("#kanBanProductDetail").on("change",".ms2m",function(){var i,u;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,f=($(n).find(`.C_${t}`).attr("old")>>0)-1,r=($(n).find(`.C_${t}`).val()>>0)-1,e=($(n).find(`.O_${t}`).val()>>0)-1,o=$(n).find(`.Time_${t}`).val()>>0,s=$(n).find(`.Range_${t}`).val()>>0,h=$(n).find(`.Step_${t}`).val()>>0,c=$(n).find(`.IsSum_${t}`).is(":checked");i=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(i)&&(i=[]);const l=$(n).find(`.Shift_${t}`).val()>>0;f==r&&(u=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==e),kanBanItemsTmp.forEach(n=>{if(n==u[0]){n.ConfigList||(n.ConfigList=[]);var t=0;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=l;n.ConfigList[t][1]=o;n.ConfigList[t][2]=s;n.ConfigList[t][3]=c?1:0;t=1;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=h;t=2;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==9&&(n.ConfigList[t]=i);t=3;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==11&&(n.ConfigList[t]=i)}}))});$("#kanBanProductDetail").on("ifChanged",".cbs",function(){var i,u;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,f=($(n).find(`.C_${t}`).attr("old")>>0)-1,r=($(n).find(`.C_${t}`).val()>>0)-1,e=($(n).find(`.O_${t}`).val()>>0)-1,o=$(n).find(`.Time_${t}`).val()>>0,s=$(n).find(`.Range_${t}`).val()>>0,h=$(n).find(`.Step_${t}`).val()>>0,c=$(n).find(`.IsSum_${t}`).is(":checked");i=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(i)&&(i=[]);const l=$(n).find(`.Shift_${t}`).val()>>0;f==r&&(u=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==e),kanBanItemsTmp.forEach(n=>{if(n==u[0]){n.ConfigList||(n.ConfigList=[]);var t=0;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=l;n.ConfigList[t][1]=o;n.ConfigList[t][2]=s;n.ConfigList[t][3]=c?1:0;t=1;n.ConfigList[t]||(n.ConfigList[t]=[]);n.ConfigList[t][0]=h;t=2;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==9&&(n.ConfigList[t]=i);t=3;n.ConfigList[t]||(n.ConfigList[t]=[]);n.Item==11&&(n.ConfigList[t]=i)}}))});$("#kanBanProductDetail").on("click",".sUpTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u-1),n.XvHao==t-1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t})}});showPreProduct()});$("#kanBanProductDetail").on("click",".sDownTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u+1),n.XvHao==t+1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t})}});showPreProduct()});$("#kanBanProductDetail").on("change",".cb",function(){var i,n;const r=$(this).closest(".kb_div1"),t=$(r).attr("display")>>0;if(t==0){i=$(this).prop("checked");const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0,u=($(t).find(`.C_${r}`).val()>>0)-1,f=($(t).find(`.O_${r}`).val()>>0)-1,e=$(this).closest("tr"),o=$(e).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f);kanBanItemsTmp.forEach(t=>{var u,r,f;t==n[0]&&(u=t.FieldList.length,t.FieldList.forEach(n=>{n.XvHao==o&&(n.Order=i?u+1:0)}),r=t.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r.forEach((n,t)=>{n.Order=t+1}),f=t.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao")),t.FieldList=r.concat(f),t.FieldList.forEach((n,t)=>{n.XvHao=t}))})}else if(t==1){const t=$(this).closest(".kb_div1"),i=$(t).attr("value")>>0,r=($(t).find(`.C_${i}`).val()>>0)-1,u=($(t).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),e=$(f).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(t=>{t==n[0]&&t.FieldList.forEach(n=>{n.Order=n.XvHao==e?1:0})})}showPreProduct()});$("#kanBanProductDetail").on("change",".fieldSet",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,r=($(n).find(`.C_${i}`).val()>>0)-1,u=($(n).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),t=$(f).attr("value")>>0,e=$(n).find(`.Com_${t}`).val(),o=$(n).find(`.Wid_${t}`).val(),s=$(n).find(`.Func_${t}`).val(),h=$(n).find(`.Pre_${t}`).val(),c=$(n).find(`.Suf_${t}`).val();var l=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(n=>{n==l[0]&&n.FieldList.forEach(n=>{n.XvHao==t&&(n.Column=e,n.Width=o,n.Func=unescape(s),n.Pre=h,n.Suffix=c)})})});var i=new Promise(n=>getWorkshop(n)),r=new Promise(n=>getStep(n)),u=new Promise(n=>getProduction(n)),f=new Promise(n=>getDevice(n)),e=new Promise(n=>getProcessor(n));i.then(()=>{Promise.all([r,u,f,e]).then(()=>{new Promise(n=>getKanBanList(n)).then(n=>{const i=n[0],t=n[1];t.length>0&&$("#kanBanList").trigger("select2:select")})})})}function initColName(n=true){let t=$("#kanBanContentCol").val()>>0;const u=$("#kanBanList").val(),i=kanBans[u];i&&(n&&(t=i.ContentCol),n&&(colName=i.ColName?i.ColName.split(","):[]));let r=colName.length;if(t>r)for(let n=colName.length,i=t;n<i;n++)colName[n]||(colName[n]="");else colName=sliceArray(colName,t);var f=Array.from($("#kanBanItemColName .kb_item_col2").map((n,t)=>t.value));for(let n=0,t=colName.length;n<t;n++){const t=f[n];t&&(colName[n]=t)}if(n){let n="";for(let i=0;i<t;i++){const t=colName[i];n+=`<div class="input-group kb_item_div1">
                    ...
                    </div>`,"");$("#kanBanItems").html(u)}function showPreProduct(){$("#kanBanProduct h3").text($("#kanBanName").val());const n=$("#kanBanType").val(),t=kanBanItems[n]?kanBanItems[n]:[],i=colSet.length,r=colSet.reduce((n,r)=>{r.chose=r.chose.sort(sortOrder);const u=r.chose.length,f=u>1?5:4,e=u>1?"":" hidden",o=r.chose.reduce((n,r,o)=>{var h;const l=t.filter(n=>n.Item==r.val),a=kanBanItemsTmp.filter(n=>n.Col==r.col&&n.Order==r.order);if(!l.length||!a.length)return n;const c=l[0],s=a[0],ft=c.FieldList,y=s.FieldList,d=y.filter(n=>n.Order).length,g=d>1;var p=0,w=0,b=10,k=!1,nt=0,tt=[],it=[];let rt="",v="";if(~its.indexOf(c.Item)){if(s.ConfigList&&(h=0,s.ConfigList.length>h&&(p=s.ConfigList[h].length>0?s.ConfigList[h][0]:p,w=s.ConfigList[h].length>1?s.ConfigList[h][1]:w,b=s.ConfigList[h].length>2?s.ConfigList[h][2]:b,k=s.ConfigList[h].length>3?s.ConfigList[h][3]:k),h=1,s.ConfigList.length>h&&s.ConfigList[h].length>0&&(nt=s.ConfigList[h][0]),h=2,s.ConfigList.length>h&&s.ConfigList[h].length>0&&(tt=s.ConfigList[h]?s.ConfigList[h]:[]),h=3,s.ConfigList.length>h&&s.ConfigList[h].length>0&&(it=s.ConfigList[h]?s.ConfigList[h]:[])),rt=setOptions(stepTmp,"StepName"),v+=`</br>
                    <label class="control-label">工序</label>
                    <select class="form-control ms2m Step_${r.val}" value="${nt}">${rt}</select>`,c.Item!=10){let n="";c.Item==9?(n=setOptions(productionTmp,"ProductionProcessName"),v+=`计划号<select class="form-control ms2 GroupItems_${r.val}" value="${tt.join()}">${n}</select>`):c.Item==11&&(n=setOptions(processorTmp,"Name"),v+=`操作工<select class="form-control ms2m GroupItems_${r.val}" value="${it.join()}">${n}</select>`)}v+=`<label class="control-label text-red">合计
                        <input type="checkbox" class="icb_minimal cbs IsSum_${r.val}" value="${k}">
                    </label>`}else p=a.length?s.Shifts:0;const et=y.reduce((n,t,i)=>{const u=ft.filter(n=>n.Field==t.Field),o=u.length?u[0].Column:"",s=u.length?u[0].Axis:0,f=u.length?u[0].DataType:"",p=!!FieldFunc[f],w=u.length?u[0].Special:"",b=p&&!!FieldFunc[f][w],e=t.Column?t.Column:"",h=t.Color?t.Color:"",l=t.Width?t.Width:"",a=t.Pre?t.Pre:"",v=t.Suffix?t.Suffix:"",y=t.Func?t.Func:"";return n+`<tr role="row" style="background-color: #f9f9f9;" value=${t.XvHao}>
                        <td style="padding: 4px; border: 1px solid gray;">
                            ${c.Display==1&&s==0?``:c.Display==1&&s==1?`<input type="radio" name="Radio_${r.col}_${r.order}" class="cb Cho_${i}" ${t.Order?"checked":""} value="0">`:`<input type="checkbox" class="cb Cho_${i}" ${t.Order?"checked":""} value="0">`}
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">${i+1}</td>
                        <td style="padding: 4px; border: 1px solid gray;">
                            ${o}
                        </td>
                        ${c.Display==1?``:`<td style="padding: 4px; border: 1px solid gray;" class="form-inline">
                            <input style="width: auto;${h?`color:${h};`:""}" class="form-control text-center no-padding fieldSet Com_${i}" old=${e} value=${e?e:""}>
                            <img class="mColorpicker Color_${i}"><i style="cursor: pointer;" class="CClear_${i}">清除</i>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">
                            <input class="form-control text-center no-padding fieldSet Wid_${i}" placeholder="自动" old=${l} value=${l}>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">
                            <button class="btn btn-primary btn-sm Func_${i}" old="${escape(y)}" value="${escape(y)}" onclick="showFunc(this, '${o}', '${f}', ${r.col}, ${r.order}, ${t.XvHao})">设置</button>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">
                            <input class="form-control text-center no-padding fieldSet Pre_${i}" old=${a} value=${a}>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">
                            <input class="form-control text-center no-padding fieldSet Suf_${i}" old=${v} value=${v}>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline Or_${i}" value=${t.Order}>
                            <span class="glyphicon glyphicon-arrow-up pointer text-green${i==0?" hidden":""} ${g&&t.Order?"":" hidden"} sUpTr" aria-hidden="true" title="上移"></span>
                            <span class="glyphicon glyphicon-arrow-down pointer text-red${i+1==d?" hidden":""} ${g&&t.Order?"":" hidden"}   sDownTr" aria-hidden="true" title="下移"></span>
                        </td>`}
                    </tr>`},"");let ut="";return ut=~its.indexOf(c.Item)?workshopTmp[workshopId].ShiftNameList.reduce((n,t,i)=>`${n}<option value="${i+1}">${t}</option>`,'<option value="0">全天<\/option>'):setOptions(shifts,"Type"),`${n}<div class="kb_div1" style="height: ${r.height==-1?"auto":`${r.height}%`}" col="${r.col}" order="${r.order}" value="${r.val}" display="${c.Display}" >
                    <div class="kb_border1">
                        <div class="kb_border3" style="padding: 5px;">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th colspan="${f}" class="bg-green" style="padding: 4px; border: 1px solid gray; width: auto;">
                                            ...
                                            <button type="button" class="btn btn-danger btn-xs itemDelBtn" value=${r.val} style="float: right;"><i class="fa fa-minus"></i></button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline">
                                            ...
                                            <select class="form-control colSet DF_${r.val}" value=${r.dField?r.dField:""} style="width: auto;">
                                                ${setOptionsWithKey(y,"Field","Column")}
                                            </select>
                                        ...
                                        ${!l[0].BShifts&&!l[0].BDuration?"":`<tr role="row" style="background-color: #f9f9f9;">
                                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline" colspan="${f}" >
                                            <div class="form-group form-inline">
                                            ${l[0].BShifts?`<label class="control-label">班制</label>
                                                <select class="form-control colSet Shift_${r.val}" value=${p}>${ut}</select>`:""}
                                            ${l[0].BDuration?~its.indexOf(c.Item)?`<label class="control-label">时间类型</label>
                                                <select class="form-control colSet Time_${r.val}" value=${w}>${timeOptions}</select>
                                                <label class="control-label">时间范围</label>
                                                <div class="input-group">
                                                    <input class="form-control text-center colSet Range_${r.val}" style="width: 70px;" value=${b} oninput="onInput(this, 3, 0, 0, 24);">
                                                    <div class="input-group-addon">${timeTypes[w]}</div>
                                                </div>
                                                ${v}`:`<label class="control-label">显示最近</label>
                                                <input class="form-control text-center colSet Hour_${r.val}" style="width: 70px;" value=${a.length?s.Hour:24} oninput="onInput(this, 3, 0, 0, 24);">
                                                <label class="control-label">小时</label>
                                                <input class="form-control text-center colSet Min_${r.val}" style="width: 70px;" value=${a.length?s.Min:0} oninput="onTimeLimitInput(this);">
                            ...
                            <br>
                            ${y.length?`<table class="table table-striped no-margin">
                                <thead>
                                    <tr role="row">
                                    ...
                                    <tr role="row" style="background-color: #f9f9f9;">
                                        ...
                                        ${c.Display==1?``:`<th style="padding: 4px; border: 1px solid gray; width: auto;">
                                            自定义及颜色
                                        </th>
                                        <th style="padding: 4px; border: 1px solid gray; width: auto;">
                                            列宽(px)
                    ...
                    ${o}
                 </div>`},"");$("#kanBanProductDetail").html(r).find("select").each((n,t)=>{var i=$(t).attr("value"),r;$(t).hasClass("ms2m")?(~i.indexOf(",")?($(t).select2({allowClear:!0,placeholder:"请选择",multiple:!0,width:"55%",matcher}),i=i.split(",")):$(t).select2({matcher,width:"120px"}),$(t).val(i).trigger("change")):$(t).hasClass("ms2")?($(t).select2({allowClear:!0,placeholder:"请选择",multiple:!0,width:"55%"}),r="",isStrEmptyOrUndefined(i)||(r=i.split(",")),$(t).val(r).trigger("change")):$(t).val(i)}).end().find(".icb_minimal").each((n,t)=>{var i=$(t).attr("value");$(t).iCheck({handle:"checkbox",checkboxClass:"icheckbox_minimal-red",increaseArea:"20%"}).iCheck(i==1?"check":"unckeck")}).end().find(".kb_border3").each((n,t)=>{const i=$(t).closest(".kb_div1"),f=$(i).attr("value")>>0,r=($(i).find(`.C_${f}`).val()>>0)-1,u=($(i).find(`.O_${f}`).val()>>0)-1,e=colSet[r].chose[u].dOrder?colSet[r].chose[u].dOrder:0,o=colSet[r].chose[u].dField?colSet[r].chose[u].dField:"";$(t).find(`.DO_${f}`).val(e);$(t).find(`.DF_${f}`).val(o);var s=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(n=>{n==s[0]&&(n.Top&&$(t).scrollTop(n.Top),n.Left&&$(t).scrollLeft(n.Left),n.FieldList.forEach((n,t)=>{const r=n.Color?n.Color:defColor;$(i).find(`.Color_${t}`).colorpicker({allowEmpty:!0,color:r,format:"rgb"});$(i).find(`.CClear_${t}`).on("click",function(){$(this).siblings(`.Color_${t}`).colorpicker("setValue","")})}))});$(t).scroll(n=>{const t=$(n.target).closest(".kb_div1"),i=$(t).attr("value")>>0,r=($(t).find(`.C_${i}`).val()>>0)-1,u=($(t).find(`.O_${i}`).val()>>0)-1;var f=$(n.target).scrollTop(),e=$(n.target).scrollLeft(),o=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(n=>{n==o[0]&&(n.Top=f,n.Left=e)})})}).end().find(".mColorpicker").on("changeColor",function(n){var t=n.color.toHex(),u;if(t!="#ffffff"){t=="#aN"&&(t="");$(this).siblings("input").css("color",t);const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,f=($(i).find(`.C_${r}`).val()>>0)-1,e=($(i).find(`.O_${r}`).val()>>0)-1,o=$(this).closest("tr"),s=$(o).attr("value")>>0;u=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{n==u[0]&&n.FieldList.forEach(n=>{n.XvHao==s&&(n.Color=t)})})}})}function showFunc(n,t,i,r,u,f){var o,s,h;const c=$(n).attr("value")?$(n).attr("value"):"[]",e=JSON.parse(unescape(c));$("#showFuncModal .modal-title").text(`${t}-逻辑处理`).attr("func",i).attr("c",r).attr("o",u).attr("pxh",f);o=e.special?e.special:"";$("#showFunc").html(setFieldOptions(i)).val("");$("#showFunc").val(o);s=e.bold?e.bold:0;$("#boldFunc").val(s);h=e.color?e.color:0;$("#conFunc").empty();$("#colorFunc").val(0).off("change").on("change",function(){var n=$(this).val();n==2?$("#conFunc").closest(".conDiv").removeClass("hidden"):$("#conFunc").closest(".conDiv").addClass("hidden")});$("#colorFunc").val(h).trigger("change");e&&e.cons&&e.cons.length&&e.cons.forEach((n,t)=>{addConTr();const i=t+1,r=$(`#conFunc .ctr_${i}`);$(r).find(`.con_${i}`).val(n.con);$(r).find(`.conv_${i}`).val(n.conv);$(r).find(`.tcolor_${i}`).val(n.color);$(r).find(`.ccolor_${i}`).css("background-color",n.color)});$("#showFuncModal").modal("show")}function addConTr(){const r=$("#conFunc tr").length,n=r+1;var u=`<tr class="ctr_${n}">
            <td class="xh xh_${n}">
                ${n}
            </td>
            <td class="form-inline">
                <select class="form-control con_${n}" style="width: auto;">
                    ${conOptions}
                </select>
                <input type="text" class="form-control text-center conv_${n}" style="width: auto;">
            </td>
            <td>
                <div class="input-group color_${n}">
                  <input type="text" class="form-control hidden tcolor_${n}" style="width: auto;" readonly value="${defColor}">
                  <div class="input-group-addon" style="border-left: 1px solid #ccc;">
                    <i class="ccolor_${n}" style="background-color: ${defColor};"></i>
                  </div>
                </div>
            </td>
            <td>
        ...
        </tr>`;$("#conFunc").append(u);$(`#conFunc .color_${n}`).colorpicker({color:defColor,format:"rgb"}).on("changeColor",function(n){const t=n.color.toHex();t!="#ffffff"&&$(this).children("input").val(t)});const f=getDate(),i=$("#showFuncModal .modal-title").attr("func"),t=$(`#conFunc .conv_${n}`);if(i==="int")$(t).on("input",function(){onInput(this,8,0)});else if(i==="decimal")$(t).on("input",function(){onInput(this,8,4)});else i==="datetime"?($(t).addClass("form_date").val(f),initDayTime($(t).closest("td"))):i==="date"&&($(t).addClass("form_date"),initDayTime($(t).closest("td")))}function delConTr(n){const t=$(n).closest("tr");t&&t.remove();const i=$("#conFunc tr");i.each((n,t)=>{$(t).find(`.xh`).text(n+1)})}function saveCons(n=false){var t=[],o;const s=$("#showFunc").val(),h=$("#boldFunc").val()>>0,i=$("#colorFunc").val()>>0;if(i){const n=$("#conFunc tr");if(!n.length)return void layer.msg("缺少条件配置!");n.each((n,i)=>{const r=n+1,u=$(i).find(`.con_${r}`).val()>>0,f=$(i).find(`.conv_${r}`).val(),e=$(i).find(`.tcolor_${r}`).val();t.push({xh:r,con:u,conv:f,color:e})})}const r=JSON.stringify({special:s,bold:h,color:i,cons:t}),u=$("#showFuncModal .modal-title").attr("c")>>0,f=$("#showFuncModal .modal-title").attr("o")>>0,e=$("#showFuncModal .modal-title").attr("pxh")>>0;$(`#kanBanProductDetail .kb_div1[col=${u}][order=${f}] .Func_${e}`).attr("value",r);o=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f);kanBanItemsTmp.forEach(n=>{n==o[0]&&n.FieldList.forEach(n=>{n.XvHao==e&&(n.Func=r)})});n&&$("#showFuncModal").modal("hide")}function getWorkshop(n){ajaxPost("/Relay/Post",{opType:162},t=>{if(t.errno!=0){layer.msg(t.errmsg);return}workshopTmp=t.datas.sort(firstBy("Id"));workshopId=t.datas.length?workshopTmp[0].Id:0;n&&n(workshopTmp)},0)}function getStep(n){ajaxPost("/Relay/Post",{opType:150,opData:JSON.stringify({wId:workshopId,menu:!0})},t=>{if(t.errno!=0){layer.msg(t.errmsg);return}stepTmp=t.datas;n&&n(stepTmp)},0)}function getProduction(n){ajaxPost("/Relay/Post",{opType:215,opData:JSON.stringify({wId:workshopId,menu:!0})},t=>{if(t.errno!=0){layer.msg(t.errmsg);return}productionTmp=t.datas;n&&n(productionTmp)},0)}function getDevice(n){if(_permissionList[676].have){var t={opType:100,opData:JSON.stringify({wId:workshopId,script:!0,detail:!1})};ajaxPost("/Relay/Post",t,t=>{var i,e;if(t.errno!=0){layer.msg(t.errmsg);return}var r=SortNumberString(t.datas,"Code"),u='<option value="0">全部<\/option>',f=[];for(i=0,e=r.length;i<e;i++){const n=r[i];deviceTmp[n.Id]=n;u+=`<option value=${n.Id}>${n.Code}</option>`;f.push(n.Id)}$("#deviceSelect").empty().append(u);n(f)},0)}}function getProcessor(n){ajaxPost("/Relay/Post",{opType:248,opData:JSON.stringify({wId:workshopId,menu:!0})},t=>{if(t.errno!=0){layer.msg(t.errmsg);return}processorTmp=t.datas;n&&n(processorTmp)},0)}function getKanBanList(n){ajaxPost("/Relay/Post",{opType:509,opData:JSON.stringify({wId:workshopId,init:!0})},t=>{var r,c,l,f,u,e,nt,tt,i,h,it;if(t.errno!=0){layer.msg(t.errmsg);return}r=t.data;const p=r.length;if(!(p<=0)){c=`<div class="box box-primary">
            ...
            </div>`;l=`<div class="kb_div1" style="height: {2}" val="{3}">
                <div class="kb_border1">
                    <div class="kb_border2">
            ...
            </div>`;f=`<div class="tab-pane {2} {3}" id="{0}">{1}</div>`;const a=`<div class="item kb_body" id="{0}">{1}<div class="carousel-caption text-primary"><h3 class="text-primary isShow hidden">{2}</h3></div></div>`;let v=!_permissionList[676].have;u=$("#kanBanType").val();$("#kanBanType").html(setOptions(t.menu,"Type",!0));u?$("#kanBanType").val(u):$("#kanBanType").trigger("change");u=$("#kanBanType").val();const k=$("#kanBanList").val()>>0,y=r.filter(n=>n.Type==u&&n.Id!=0);let rt=0;const ut=y.reduce((n,t)=>t.Id!==0&&t.Type==u?`${n}<option value=${t.Id}>${++rt}-${t.Name}</option>`:"","");if($("#kanBanList").html(ut),k)$("#kanBanList").val(k);else if(y.length>0){const n=y[0];$("#kanBanList").val(n.Id)}for(e in t.item)kanBanItems[e]=[],t.item[e].forEach(n=>{kanBanItems[e][n.Item]=n});shifts=t.shift;var d="",g="",o="",s="";carouselTmp=[];nt=0;for(let n=0;n<p;n++){const t=r[n];kanBans[t.Id]=t;const u=$("#kanBanType").find(`[value=${t.Type}]`).css("color");if(d+=`<div class="flexStyle pointer choseBox mPadding">
                        <label class="flexStyle pointer">
                            <input type="checkbox" class="icb_minimal" value=${t.Id}>
                            <span style="margin-left: 5px">${t.Name}</span>
                        </label>
                    </div>`,t.IsShow){tt=v&&n==0?' class="active"':"";i=`kanBan_${t.Id}`;g+=`<li${tt}><a href="#${i}" class="kanBan text-bold" data-toggle="tab" aria-expanded="false" style="${u?`color: ${u};`:""}">${t.Name}(${t.Order})</a></li>`;const r=`carousel_${i}`;h=v&&n==0?" active":" fade in";switch(t.Type){case 1:o+=f.format(i,c.format(i,""),"",h);s=a.format(r,c.format(r,"hidden"),t.Name);break;case 2:o+=f.format(i,w.format(i,""),"kb_body",h);s=a.format(r,w.format(r,"hidden"),t.Name);break;case 3:t.ColSet||(t.ColSet="[]");it=JSON.parse(t.ColSet);const n=[];t.ItemList&&t.ItemList.forEach(t=>{n[t.Item]=t});function u(i){return it.reduce((r,u)=>{var f=u.chose.reduce((r,u)=>{var f="";const e=n[u.val];if(e){const r=e.FieldList?e.FieldList.filter(n=>n.Order):[],n=kanBanItems[t.Type][u.val];n.Display==0?f=l.format(getTableW(`${i}_${u.col}_${u.order}`,r,3),u.name?u.name:n.Name,u.height==-1?"auto":`${u.height}%`,u.val):n.Display==1&&(f=l.format(getChartW(`${i}_${u.col}_${u.order}`,r,3),u.name?u.name:n.Name,u.height==-1?"auto":`${u.height}%`,u.val))}return r+f},"");return`${r}<div class="" style="width: ${u.width}%; height: 100%;">
                                            ${f}
                                        </div>`},"")}o+=f.format(i,b.format(i,t.Name,"",u(i)),"kb_body",h);s=a.format(r,b.format(r,t.Name,"hidden",u(r)),t.Name)}carouselTmp[t.Id]||(carouselTmp[t.Id]={});carouselTmp[t.Id]={carouselLi:`<li data-target="#carousel-example-generic" data-slide-to=${nt++}></li>`,carouselTab:s}}}$("#carouselDiv").empty().append(d).find(`.icb_minimal`).iCheck({handle:"checkbox",checkboxClass:"icheckbox_minimal-green",increaseArea:"20%"}).on("ifChanged",function(){const n=$(this).val();$(this).is(":checked")?carouselChose.push({id:n,Order:kanBans[n].Order}):removeArray(carouselChose,"id",n);carouselChose.sort(sortOrder)});$("#firstNavLi").nextAll().remove().end().after(g).end();v&&$("#tabBox a:not(:first)").first().click();$("#setKanBan").nextAll().remove().end().after(o);r=r.filter(n=>n.Id!==0);n&&n(r)}},0)}function setAddKanBan(n){const u=$("#kanBanName").val().trim();if(isStrEmptyOrUndefined(u))return void layer.msg("看板名称不能为空");const i=$("#kanBanType").val()>>0;if(isStrEmptyOrUndefined(i))return void layer.msg("看板类型错误");const o=$("#kanBanOrder").val()>>0,f=$("#deviceSelect").val();if(isStrEmptyOrUndefined(f))return void layer.msg("请选择设备");const s=$("#kanBanUI").val()>>0,h=$("#kanBanSecond").val()>>0,c=$("#kanBanRow").val()>>0,l=$("#kanBanCol").val()>>0,e=$("#kanBanContentCol").val()>>0,a=Array.from($("#kanBanItemColName .kb_item_col2").map((n,t)=>t.value)),v=$("#isShow").is(":checked");let r=[];scriptIndexTmp.forEach(n=>{var t=scriptTmp[n];const i=`${t.divVal}Data`,u=`${t.divIn}Data`,f=`${t.divOut}Data`;t&&t[i]&&t[u]&&t[f]&&(r=r.concat(t[i],t[u],t[f]))});const t={Type:i,IsShow:v,Name:u,DeviceIds:f.join(","),Order:o,UI:s,Second:h,Row:c,Col:l,ContentCol:e,ColName:"",ColSet:"[]",Variables:"[]",Items:"[]"};if(i==2){t.ColName=a.join();const n=getMaxSet(e);t.Variables=JSON.stringify(r.filter(t=>t.Order<=n))}else if(i==3){for(var y in kanBanItemsTmp){const n=kanBanItemsTmp[y];if(!n.FieldList||!n.FieldList.length||!n.FieldList.filter(n=>n.Order).length)return void layer.msg("请选择列")}t.Items=JSON.stringify(kanBanItemsTmp);t.ColSet=JSON.stringify(colSet)}if(!n){const n=$("#kanBanList").val();if(isStrEmptyOrUndefined(n))return void layer.msg("请选择需要修改的看板");t.Id=n>>0}const p={opType:n?510:511,opData:JSON.stringify(t)};ajaxPost("/Relay/Post",p,n=>{layer.msg(n.errmsg),n.errno==0&&(pTableOrChart=[],getKanBanList())})}function getFieldList(n){var t="[]";return n.FieldList&&n.FieldList.length&&(n.FieldList.forEach(n=>getFieldList(n)),t=JSON.stringify(n.FieldList)),n.Fields=t,n}function delKanBanList(){var n=$("#kanBanList").val(),t;if(isStrEmptyOrUndefined(n)){layer.msg("请选择需要删除的看板");return}t=()=>{var t={opType:512,opData:JSON.stringify({id:n})};ajaxPost("/Relay/Post",t,n=>{layer.msg(n.errmsg),n.errno==0&&getKanBanList()})};showConfirm(`删除：${$("#kanBanList :selected").text()}`,t)}function getMaxSet(n){return n==2?6:(n-3)*5+10}function getFirstOrders(n){var i,t,r;if(n>2){const u=n-1,f=getMaxSet(n),e=Math.floor(f/u);for(i=[],t=0;t<e;t++)r=1+u*t,i.push(r)}return i}function getScriptList(){var n={opType:106,opData:JSON.stringify({sIds:scriptIndexTmp.join()})};ajaxPost("/Relay/Post",n,n=>{if(n.errno!=0){layer.msg(n.errmsg);return}var r=`<div class="box box-info" id="{0}">
                <div class="box-header with-border">
        ...
        </div>`;if(carouselChose.length){const t=carouselChose.reduce((n,t)=>`${n}${carouselTmp[t.id].carouselLi}`,""),i=carouselChose.reduce((n,t)=>`${n}${carouselTmp[t.id].carouselTab}`,"");_carouselBox=n.format(t,i);carouselChose.forEach(n=>{page[n.id]=0,dsDivs[n.id]=[],dsPaths[n.id]=[]});carouselId=0;carouselIndex=0;$("#fullScreenCarousel").empty().append(_carouselBox);$("#fullScreenCarousel").find("ol li:first").addClass("active");$("#fullScreenCarousel").find(".item:first").addClass("active");$("#fullScreenCarousel").animate({top:0,opacity:1},1e3,"linear",()=>{});carouselFlag=$("#fullScreenCarousel .item:first").attr("id");setFullScreenCarousel(carouselFlag);$("#carousel-example-generic").carousel({interval:1e4}).off("slide.bs.carousel").on("slide.bs.carousel",n=>{if(carouselFlag=n.relatedTarget.id,carouselId=carouselFlag.replace("carousel_kanBan_",""),kanBans[carouselId]){if($(`#fullScreenCarousel .ftitle`).length&&$(`#fullScreenCarousel .ftitle`).text(` - ${kanBans[carouselId].Name}`),carouselFlag=="")return;setChart(carouselFlag,carouselId,kanBans[carouselId].Type,!0)}}).on("mouseenter",()=>$("#carousel-example-generic .isShow").removeClass("hidden")).on("mouseleave",()=>$("#carousel-example-generic .isShow").addClass("hidden")).on("mousemove",()=>{$("html").css({cursor:"default"}),checkMouseMove&&clearTimeout(checkMouseMove),checkMouseMove=setTimeout(function(){console.log("hide");$("html").css({cursor:"none"});$("#carousel-example-generic").trigger("mouseleave")},5e3)})}}function setFullScreenCarousel(){(clearInterval(carouselTime),carouselFlag!="")&&(carouselTime=setInterval(()=>{if(carouselId=carouselFlag.replace("carousel_kanBan_",""),kanBans[carouselId]){if($(`#fullScreenCarousel .ftitle`).text(` - ${kanBans[carouselId].Name}`),carouselFlag=="")return;setChart(carouselFlag,carouselId,kanBans[carouselId].Type,!0)}},5e3))}function cancelFullScreenCarousel(){kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))});checkMouseMove&&clearTimeout(checkMouseMove);clearInterval(carouselTime);carouselFlag="";$("#carousel-example-generic").carousel("pause").off("slide.bs.carousel mouseenter mouseleave");$("#fullScreenCarousel").animate({top:"-100%",opacity:0},1e3,"linear",function(){$(this).empty();fullScreen(!1)})}function setChart(n,t,i,r=false){var u,f;if(!run){run=!0;u=`#${n}`;const e=page[t]?page[t]:0;f={opType:509,opData:JSON.stringify({qId:t,page:e})};ajaxPost("/Relay/Post",f,e=>{var h,k,o,lt,ri,ui,fi,at,ei,vt,oi,ft,yt,pt,a,c,pi,wi,it,bi,wt,et,bt,ot,ki,s,kt,d,di,gi,dt,rt,w,gt,st,ht,ni,ct,v,ir,p,ut;run=!1;const nt="text-red",tt="text-gray";if(lt=new Date,d||(d=e.time,tn=lt),d!=e.time&&(d=e.time,tn=lt),e.errno==0?(ri=$(`${u}_time`).text(),ui=e.time,Math.abs(dateDiffSec(ui,ri))>60?($(`${u}_time`).toggleClass(nt),$(`${u}_time`).toggleClass(tt)&&$(`${u}_time`).removeClass(tt)):($(`${u}_time`).toggleClass(tt),$(`${u}_time`).hasClass(nt)&&$(`${u}_time`).removeClass(nt))):($(`${u}_time`).hasClass(nt)||$(`${u}_time`).addClass(nt),$(`${u}_time`).hasClass(tt)&&$(`${u}_time`).removeClass(tt),run=!1),o=e.data,i==1){if(e.errno!=0)return;fi=setPieChart(`${u}_detail`,"Rate",o.AllProcessRate,"#0099ff");$(`${u}_yxTime`).text(codeTime(o.RunTime));$(`${u}_jgTime`).text(codeTime(o.ProcessTime));$(`${u}_xzTime`).text(codeTime(o.IdleTime));$(`${u}_lly`).text(fi);at=`${o.MaxUse}台`;ei=setPieChart(`${u}_max`,`Max
${at}`,o.MaxUseRate,"#00a65a");$(`${u}_maxTs`).text(`${o.MaxSimultaneousUseRate}台`);$(`${u}_maxTNum`).text(at);$(`${u}_maxSyl`).text(ei);vt=`${o.MinUse}台`;oi=setPieChart(`${u}_min`,`Min
${vt}`,o.MinUseRate,"#f39c12");$(`${u}_minTs`).text(`${o.MinSimultaneousUseRate}台`);$(`${u}_minTNum`).text(vt);$(`${u}_minSyl`).text(oi);var l=o.AllDevice,si=o.NormalDevice,hi=o.ProcessDevice,ci=o.IdleDevice,li=o.FaultDevice,ai=o.ConnectErrorDevice;for(setPieChart(`${u}_state_all`,`${l}台`,l/l,"green","总设备"),setPieChart(`${u}_state_normal`,`${si}台`,si/l,"blue","正常运行"),setPieChart(`${u}_state_process`,`${hi}台`,hi/l,"#0099ff","加工中"),setPieChart(`${u}_state_idle`,`${ci}台`,ci/l,"#cc33ff","闲置中"),setPieChart(`${u}_state_fault`,`${li}台`,li/l,"red","故障中"),setPieChart(`${u}_state_error`,`${ai}台`,ai/l,"#ff00cc","连接异常"),yt=o.UseCodeList||[],k="",h=0,ft=yt.length;h<ft;h++)k+=`<div style="border:1px solid;padding:5px 10px;margin:3px;border-radius:20%;background:#bfa;font-weight:bold">${yt[h]}</div>`;$(`${u}_dev`).empty().append(k||'<label style="color:red;font-size:18px">无<\/label>');var vi=o.SingleProcessRate,y=[],yi=[];for(h=0,ft=vi.length;h<ft;h++)pt=vi[h],y.push(pt.Code),yi.push((pt.Rate*100).toFixed(2));p={tooltip:{trigger:"axis",formatter:"{a}<br/>{b} : {c}%",axisPointer:{type:"shadow"}},grid:{left:"3%",right:"3%",top:"6%",bottom:"8%",containLabel:!0},xAxis:{type:"category",axisLine:{onZero:!1},data:y},yAxis:{name:"百分比",type:"value",scale:!0,axisLabel:{show:!0,formatter:"{value}%"}},series:{name:"利用率",type:"bar",areaStyle:{normal:{}},barWidth:"60%",label:{show:!0,position:"top",formatter:"{c}%"},itemStyle:{color:n=>n.value<30?"red":"green"},data:yi},dataZoom:[{type:"inside"},{handleIcon:_handleIcon,handleSize:"80%",handleStyle:{color:"#fff",shadowBlur:3,shadowColor:"rgba(0, 0, 0, 0.6)",shadowOffsetX:2,shadowOffsetY:2}}]};echarts.init($(`${u}_bar`)[0]).setOption(p,!0);$(u).off("resize").on("resize",function(){clearTimeout(this.time);this.time=setTimeout(()=>{for(var t=$(this).find(".chart"),n=0,i=t.length;n<i;n++)echarts.init(t[n]).resize()},200)});a=o.ProductionList;const n=a.reduce((n,t)=>`${n}<td class="text-blue">${t.Code}</td>`,""),t=a.reduce((n,t)=>`${n}<td>${t.DayTotal}</td>`,""),i=a.reduce((n,t)=>`${n}<td>${t.DayQualified}</td>`,""),r=a.reduce((n,t)=>`${n}<td>${t.DayUnqualified}</td>`,""),f=a.reduce((n,t)=>`${n}<td>${t.DayQualifiedRate}%</td>`,""),s=a?a.filter(n=>n.DayTotal>0).length:0;$(`${u}_devs`).text(s);$(`${u}_pros`).text(o.DayTotal);$(`${u}_heGes`).text(o.DayQualified);$(`${u}_liePians`).text(o.DayUnqualified);$(`${u}_rates`).text(`${o.DayQualifiedRate}%`);$(`${u}_devOps`).find("td:not(:first)").remove().end().append(n);$(`${u}_proOps`).find("td:not(:first)").remove().end().append(t);$(`${u}_heGeOps`).find("td:not(:first)").remove().end().append(i);$(`${u}_liePianOps`).find("td:not(:first)").remove().end().append(r);$(`${u}_rateOps`).find("td:not(:first)").remove().end().append(f)}else if(i==2){if(c=`${u}_deviceState`,e.errno!=0){dsDivs[t].forEach(n=>{$(`#${n}`).addClass("hi")});$(`${c} .hi`).css("display","none").removeClass("hi");return}pi=`<div id="{0}" class="kb_device_div1 ds" style="display:none;">
                    ...
                    <div style="top: 2%; height: 65%; position: relative;" id="{0}_detail"></div>
                </div>`;const i=dsDivs[t].length;if(i!==e.len){k="";wi=Math.abs(e.len-i);for(let r=0;r<wi;r++){const u=`${n}_ds${i+r}`;i<e.len?(dsDivs[t].push(u),k+=pi.format(u)):i>e.len&&removeArray(dsDivs[t],u)}i<e.len?$(`${c}`).append(k):i>e.len&&$(`${c} .rm`).remove()}const y=$(`${u} .dsDiv`);y.length>0&&(it=$(window).height(),$(`${u}`).css("height",`${it}px`),it=$(`${u} .kb_border2`).height()>>0,bi=$(`${u} .ttDiv`).height()>>0,$(`${u} .dsDiv`).css("height",`${it-bi}px`));const s=SortNumberString(o,"Code");let l=s.length;if(!l){dsDivs[t].forEach(n=>{$(`#${n}`).addClass("hi")});$(`${c} .hi`).css("display","none").removeClass("hi");$(c).append('<div class="no-data" style="font:bold 25px/35px 微软雅黑;color:red">无数据<\/div>');return}const v=`${c} .no-data`;$(v).length>0&&$(v).remove();wt=n=>{function it(n,t,i){var u,o,r;let e="";const f=t-1;if(n.length>0){const h=Math.max.apply(null,n.map(n=>n.Order))+1,s=Math.floor(h/f);if(t==2)for(u=0;u<s;u++){let i="";const t=n.filter(n=>n.Order==u+1);if(t.length){for(r=0;r<f;r++)if(!isStrEmptyOrUndefined(t[r].VName)){i=t[r].VName;break}let n=!1;const u=t.reduce((t,i,r)=>(isStrEmptyOrUndefined(i.V)||(n=!0),r==0?`${t}${i.V}`:`${t}${n?i.Delimiter:""}${i.V}`),"");e+=`<div class="form-group no-margin" style="height:calc(100%/6);">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 no-margin text-blue no-padding kb_param1">
                            ...
                            </table>`}}return e}var a,v,f,o;if(n)for(l=n.length,h=0;h<l;h++)a=n[h],dsPaths[t][a.name]||(dsPaths[t][a.name]=a.path);const tt=Object.keys(dsPaths[t]).length;if(!(tt<=0)){for(v=[],s.forEach(n=>v[n.Id]=1),h=0;h<i;h++){const n=`${u}_ds${h}`;if(f=s[h],f){o="red";switch(f.DeviceStateStr){case"加工中":o="#00A65C";break;case"待机":case"流程升级中":case"固件升级中":case"设备重启中":case"连接正常":o="#f47920";break;case"已报修":case"已确认":case"维修中":o="red";break;default:o="gray"}const i=it(f.Data,e.cCol,e.cName);$(`${n}_img`).attr("src",dsPaths[t][f.Icon]);$(`${n}_code`).text(f.Code);$(`${n}_mc`).text(`${f.CategoryName}-${f.ModelName}`);$(`${n}_ws`).text(f.SiteName);$(`${n}_state`).css("background",o);$(`${n}_detail`).html(i);$(`${n}`).addClass("sh")}else $(`${n}`).addClass("hi")}$(`${c} .sh`).css("display","block").removeClass("sh");$(`${c} .hi`).css("display","none").removeClass("hi");$(`${u}_jg`).text(e.jg);$(`${u}_xz`).text(e.xz);$(`${u}_zc`).text(e.zc);$(`${u}_gz`).text(e.gz);$(`${u}_wlj`).text(e.wlj);$(`${u}_sum`).text(e.sum);var y=$(".ds"),p=y.length>0?($(y[0]).css("margin").replace("px","")>>0)*2:5,rt=($(c).css("padding").replace("px","")>>0)*2;if(e.row>0){var w=$(c).width(),b=Math.floor(w/(def+p)),ut=e.col>b?b:e.col,k=Math.floor(w/ut)-p,ft=$(window).height();$(`${u}`).css("height",`${ft}px`);var d=$(c).closest(".dsDiv").height(),g=Math.floor(d/def),et=e.row>g?g:e.row,nt=Math.floor(d/et)-rt;$(".ds").css("flex-basis",`${k<def?def:k}px`).css("height",`${nt<def?def:nt}px`)}r&&(page[t]=++e.cp)}};const a=[];for(h=0;h<l;h++)et=s[h],dsPaths[t][et.Icon]||~a.lastIndexOf(et.Icon)||a.push(et.Icon);if(a.length>0){f={type:fileEnum.Device,files:JSON.stringify(a)};f.dir="";for(bt in fileEnum)if(fileEnum[bt]==f.type){f.dir=bt;break}if(isStrEmptyOrUndefined(f.dir))return void layer.msg("文件类型不存在！");getFilePath(f,wt,0)}else wt()}else if(i==3){if(e.errno!=0)return;if(!e.data)return;var o=e.data,rr=e.colSet?JSON.parse(e.colSet):[],ur=`${u}_productDiv`,it=$(window).height(),fr=$(`${u} .kb_title1`).closest("div").height()>>0;for($(`${ur}`).css("height",`${it-fr}px`),ot=0,ki=e.items.length;ot<ki;ot++){const t=e.items[ot],l=t.Item,r=kanBanItems[i][l],h=rr[t.Col].chose[t.Order];if(t&&r&&h){const a=r.FieldList?r.FieldList:[],c=[];a.forEach(n=>{c[n.Field]=n});const k=t.FieldList?t.FieldList:[],f=k.filter(n=>n.Order).sort(firstBy("Order"));if(f&&f.length){const e=`${t.Item}_${t.Col}_${t.Order}`,i=`${u}_${t.Col}_${t.Order}`,nt=$(`${i}`).closest(".kb_border2").height(),it=$(`${i}`).closest(".kb_border2").find("h4").height(),tt=nt-it;if($(`${i}`).closest(".table-responsive").css("height",`${Math.floor(tt*100/nt)}%`),$(`${i}`).closest(".kb_border2").find(".tt1").text(h.name),!o.hasOwnProperty(e))continue;if(s=o[e],r.Display==0){const e=h.dOrder=="0"?"asc":"desc";s=s.sort(firstBy(h.dField,e));$(`${i}`).closest(".kb_border2").find(".tt2").text(`(${s.length})`);addOrderData(s);let u=$(`${i} tbody tr`);if(u.length){const n=$(`${i} tr[class='max']`),h=$(n).attr("order")>>0;let o=!1;if(u.each((n,t)=>{const i=$(t).attr(trFlag),r=s.filter(n=>n[trFlag]==i);r.length||($(t).remove(),o=!0)}),o&&u.length>0&&(u=$(`${i} tbody tr`),kt=[],u.each((n,t)=>{var i=$(t).attr(trFlag)>>0;kt[i]=t}),d=Object.values(kt),d.forEach((n,t)=>{$(n).attr("order",t+1);$(n).attr(trFlag,t+1);var i="";(e=="asc"&&s.length==t+1||e=="desc"&&t==0)&&(i=`max`,$(n).addClass(i))})),!o){let o=[];if(o=e=="asc"?s.filter(n=>n.XvHao<=h):sliceArray(s,u.length,0),o.length&&o.forEach(n=>{var t,h,s;const r=$(`${i} tr[${trFlag}=${n[trFlag]}]`),l=f.filter(n=>n.Field=="XvHao");for(l.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),t=0,h=f.length;t<h;t++){const i=f[t];var o=n[i.Field],a=i.Pre?i.Pre:"",v=i.Suffix?i.Suffix:"",y=i.Width&&i.Width!=="auto"?`width: ${i.Width}px;`:`width: auto;`,e="",u="";if(c[i.Field]&&i.Func){const n=JSON.parse(i.Func);if(n.color==1?u=i.Color:n.color==2&&n.cons.every(n=>meetCondition(o,n.con,n.conv)?(u=n.color,!1):!0),n.special){const t=c[i.Field].DataType;o=FieldFunc[t][n.special].func(o)}n.bold&&(e="text-bold")}u=u?`color: ${u};`:`color: "";`;const h=`${a}${o}${v}`,l=n.XvHao,p=$(r.find("td")[t]).text(),w=$(r).attr("order")>>0;p!=h&&$(r.find("td")[t]).html(h);w!=l&&$(r).attr("order",l);s=$(r.find("td")[t]).hasClass("text-bold");e&&!s?$(r.find("td")[t]).addClass(e):!e&&s&&$(r.find("td")[t]).removeClass(e);$(r.find("td")[t]).attr("style",y);$(r.find("td")[t]).attr("style",u)}}),s.length>u.length){n.removeClass("max");let i=[];if(e=="asc")i=s.filter(n=>n.XvHao>h);else{const n=s.length-u.length;i=sliceArray(s,n)}const f=getItemTrs(i,r,t,e);e=="asc"?n.after(f):n.before(f)}else s.length<u.length&&$(`${i} tbody`).html(getItemTrs(s,r,t,e))}}else s.length&&$(`${i} tbody`).html(getItemTrs(s,r,t,e));di=$(`${i} tr`).height();gi=tt-$(`${i} tbody`).closest(".kb_item_tablebox").css("padding").replace("px","")*2;u=$(`${i} tbody tr`);dt=Math.floor(gi/di);const o=`${n}_${t.Col}_${t.Order}_timer`;u.length>dt&&!kanBanProductItemsEl[o]?scrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`):u.length<=dt&&kanBanProductItemsEl[o]&&($(`${i} tbody`).html(getItemTrs(s,r,t,e)),stopScrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`))}else if(r.Display==1){if(!s.length)continue;if(!f.length)continue;rt=f[0];w="";switch(r.DisplayType){case 0:w="line";break;case 1:w="bar";break;case 2:w="pie"}if(isStrEmptyOrUndefined(w))continue;if(gt=a.filter(n=>n.Axis==0),!gt.length)continue;st=gt[0];ht=st.Field;const n=h.dOrder=="0"?"asc":"desc";if(s=s.sort(firstBy(h.dField,n)),ni=k.filter(n=>n.Field==ht),!ni.length)continue;var nr=ni[0],ti=null,tr=null,ii=null;if(~its.indexOf(l)&&nr.Func){const n=JSON.parse(nr.Func);n.special&&(ti=FieldFunc[st.DataType][n.special].func,tr=1,t.ConfigList&&(ct=0,t.ConfigList.length>ct&&(timeType=t.ConfigList[ct].length>1?t.ConfigList[ct][1]:timeType,ii=timeTypes[timeType])))}var y=distinct(s.map(n=>ti?ti(n[ht],tr):n[ht])),b=[],g="";switch(r.Item){case 9:g="Production";break;case 10:g="Code";break;case 11:g="Processor"}if(isStrEmptyOrUndefined(g))continue;v=distinct(s.map(n=>n[g]).filter(n=>n));v.length?v.forEach(n=>{var t=s.filter(t=>t[g]==n).map(n=>n[rt.Field]);b.push({name:n,type:w,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:t})}):(ir=s.map(n=>n[rt.Field]),b.push({type:w,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:ir}));pTableOrChart[i]?(p={},ut=!1,isEqual(pTableOrChart[i].lData,v)||(ut=!0,p.legend=v),isEqual(pTableOrChart[i].xData,y)||(ut=!0,p.xAxis={data:y}),isEqual(pTableOrChart[i].series,b)||(ut=!0,p.series=b),ut&&(pTableOrChart[i].chart.setOption(p),pTableOrChart[i].lData=v,pTableOrChart[i].xData=y,pTableOrChart[i].series=b)):(pTableOrChart[i]={lData:v,xData:y,series:b,chart:echarts.init($(i)[0])},pTableOrChart[i].chart.setOption({tooltip:{trigger:"axis"},grid:{left:"3%",right:"6%",bottom:"3%",containLabel:!0},color:["#00a65a","red","#ff00ff","#cc3300","#ff9900","#9933ff","blue","#0099ff","#660066"],xAxis:{name:ii?ii:st.Field,nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"category",boundaryGap:!1,data:y,axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:19}}},yAxis:{name:rt?rt.Column:"",nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"value",axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:16}}},legend:{data:v,textStyle:{color:"white",fontWeight:"bold",fontSize:16}},series:b},!0),$(i).resize(function(){for(var n in pTableOrChart){const t=pTableOrChart[n];t.chart&&t.chart.resize()}}))}}}}}},0)}}function getItemTrs(n,t,i,r){const u=[];t.FieldList&&t.FieldList.forEach(n=>{u[n.Field]=n});const f=i.FieldList?i.FieldList.filter(n=>n.Order):[],e=f.filter(n=>n.Field=="XvHao");return e.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),n.reduce((t,i,e)=>{const s=f.reduce((n,t,r)=>{var e=i[t.Field],h=t.Pre?t.Pre:"",c=t.Suffix?t.Suffix:"",l=t.Width&&t.Width!=="auto"?`width: ${t.Width}px;`:`width: auto;`,o="",f="",r,s;if(u[t.Field]&&t.Func){const n=JSON.parse(t.Func);if(n.color==1)f=t.Color;else if(n.color==2)for(r=0,s=n.cons.length;r<s;r++){const t=n.cons[r];if(meetCondition(e,t.con,t.conv)){f=t.color;break}}if(n.special){const i=u[t.Field].DataType;e=FieldFunc[i][n.special].func(e)}n.bold&&(o="text-bold")}return f=f?`color: ${f};`:``,n+`<td class="${o}" style='${l}${f}'>${h}${e}${c}</td>`},"");var o="";return(r=="asc"&&n.length==e+1||r=="desc"&&e==0)&&(o=` class="max"`),t+`<tr${o} order=${i.XvHao} ${trFlag}=${i[trFlag]}>${s}</tr>`},"")}function setPieChart(n,t,i,r,u){i=i||0;var e=`${(i*100).toFixed(2)}%`,f={color:["#cdcdcd",r],series:{type:"pie",center:["50%","50%"],radius:["65%","100%"],hoverAnimation:!1,animation:!1,silent:!0,label:{show:!0,position:"center",formatter:`${t}
${e}`,textStyle:{color:r,fontSize:18,fontWeight:700}},data:[1-i,i]}};return u&&(f.title={text:u,left:"center",textStyle:{color:r,fontSize:16}},f.series.center=["50%","57%"],f.series.radius=["57%","85%"]),echarts.init($(n)[0]).setOption(f,!0),e}var def=175,curId=-1,t=0,uiTime=0,dataTime=0,run=!1,page=[],timeEl="",its,workshopId,workshopTmp,stepTmp,deviceTmp,processorTmp,_carouselBox,_dataTableData,tt,tn,pTableOrChart;let dsDivs=[],dsPaths=[],carouselTmp=[],carouselChose=[],carouselIndex=0,carouselId=0;var carouselTime=0,carouselFlag="",scriptIndexTmp=[],scriptTmp=[],kanBans=[],kanBanItems=[],shifts=[],kanBanItemsTmp=[],trFlag="XvHao";$(document).on("keydown",function(n){n.keyCode==27&&($(".content").find(".fullScreenBtn.fsb").click(),cancelFullScreenCarousel&&cancelFullScreenCarousel())});var kanBanProductItemsEl=[],kanBanProductItemsTables=[],tableSet=tableDefault(),_permissionList=[];let colName=[];let colSet=[];its=[9,10,11];workshopId=0;workshopTmp=[];stepTmp=[];processorTmp=[];deviceTmp=[];processorTmp=[];_dataTableData={};let checkMouseMove;pTableOrChart=[];