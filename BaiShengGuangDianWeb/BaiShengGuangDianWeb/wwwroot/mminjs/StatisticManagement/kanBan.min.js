function pageReady(){var n,i;$(".sidebar-mini").addClass("sidebar-collapse");_permissionList[675]={uIds:[]};_permissionList[676]={uIds:["firstNavLi","setKanBan"]};_permissionList[722]={uIds:["setTab","setTabLi"]};_permissionList[723]={uIds:["carouselTab","carouselTabLi"]};_permissionList=checkPermissionUi(_permissionList);!_permissionList[722].have&&_permissionList[723].have&&$("#carouselTabLi a").click();$("#kanBanList").select2();$("#deviceSelect").select2({allowClear:!0,placeholder:"请选择",multiple:!0});$("#navUl").on("click","a",function(){var n=$(this).attr("href").replace("#",""),f=n.replace("kanBan_","");const u=parseInt(f);if(curId!=u){curId=u;let r=-1;const i=kanBans[curId];i&&(r=i.Type);timeEl=n;r==2&&$(`#${n}_deviceState`).empty();curId>-1?(dsDivs[curId]=[],dsPaths[curId]=[],page[curId]=0,setChart(n,curId,r),clearInterval(uiTime),clearInterval(dataTime),t=(i.UI<1?1:i.UI)*1e3,uiTime=setInterval(()=>{run||setChart(n,curId,r,!0)},t),t=(i.Second<1?1:i.Second)*1e3,dataTime=setInterval(()=>{run||setChart(n,curId,r)},t)):(kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))}),clearInterval(uiTime),clearInterval(dataTime))}});$(".content").on("click",".fullScreenBtn",function(){var t=`#${$(this).attr("target")}`,n;$(t).toggleClass("panel-fullscreen");n=$(t).hasClass("panel-fullscreen");$(this).toggleClass("glyphicon-fullscreen glyphicon-repeat").prop("title",n?"还原":"全屏放大");n?$(this).addClass("fsb"):$(this).removeClass("fsb");fullScreen(n);n||kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))})});setInterval(()=>{$(`#${timeEl}_time`).length>0&&$(`#${timeEl}_time`).text(getFullTime()),$(`#${carouselFlag}_time`).length>0&&$(`#${carouselFlag}_time`).text(getFullTime())},1e3);n=function(){$("#kanBanLength").val(($("#kanBanRow").val()>>0)*($("#kanBanCol").val()>>0));let n=$(this).val()>>0;n==0&&(n=1,$(this).val(n));n>15&&(n=15,$(this).val(n));const t=$("#kanBanType").val()>>0;t==3&&initColSet(!1)};$("#kanBanRow").on("input",n);$("#kanBanCol").on("input",n);$("#kanBanList").on("select2:select",function(){var t=$(this).val(),n,i,r;t&&(n=kanBans[t],$("#kanBanName").val(n.Name),$("#kanBanOrder").val(n.Order),$("#isShow").iCheck(n.IsShow?"check":"uncheck"),$("#setKanBan .stateEl").addClass("hidden"),$("#setKanBan .stateEl1").addClass("hidden"),$("#setKanBan .productEl").addClass("hidden"),$("#kanBanUI").val(n.UI),$("#kanBanSecond").val(n.Second),n.Type==2?($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#kanBanContentCol").val(n.ContentCol),$("#kanBanLength").val(n.Length),$("#setKanBan .stateEl").removeClass("hidden"),scriptIndexTmp=[],scriptTmp=[],n.ContentCol>2&&($("#kanBanItemColNameDiv").removeClass("hidden"),i=getFirstOrders(n.ContentCol),r=`（首列：${i.join()},不为空的列名）`,$("#kanBanContentColDesc").text(r),initColName(!0)),$("#kanBanScript").html("")):n.Type==3&&($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#setKanBan .productEl").removeClass("hidden"),initColSet(!0),initProduct(n.Type),showPreProduct()),$("#deviceSelect").val(n.DeviceIdList).trigger("change"))});$("#deviceSelect").on("select2:select",function(){var n=$(this).val();~n.indexOf("0")&&$(this).val(0).trigger("change")}).on("change",function(){let n=$(this).val();if(isStrEmptyOrUndefined(n)){scriptIndexTmp=[];scriptTmp=[];$("#kanBanScript").html("");return}var t=[];n.length==1&&~n.indexOf("0")&&(n=deviceTmp.map(n=>n.Id).filter(n=>n));const i=$("#kanBanType").val()>>0;i==2&&(n.forEach(n=>{if(n!=0){var i=deviceTmp[n].ScriptId;~t.indexOf(i)||t.push(i);~scriptIndexTmp.indexOf(i)?existArrayObj(scriptTmp[i].ds,"id",n)||scriptTmp[i].ds.push({id:n,code:deviceTmp[n].Code}):(scriptIndexTmp.push(i),scriptTmp[i]={sId:i,sName:deviceTmp[n].ScriptName,ds:[{id:n,code:deviceTmp[n].Code}]})}}),scriptIndexTmp=t,scriptTmp.forEach(t=>{const i=t.sId;if(~scriptIndexTmp.indexOf(i)){const t=scriptTmp[i].ds.map(n=>n.id);t.forEach(t=>{~n.indexOf(t)||removeArray(scriptTmp[i].ds,"id",t)});scriptTmp[i].ds.length==0&&delete scriptTmp[i]}else scriptTmp[i].div&&$(`#${scriptTmp[i].div}`).remove(),delete scriptTmp[i]}),getScriptList())});$("#kanBanType").on("change",function(){const n=$(this).val(),i=$(this).find(`[value=${n}]`).css("color");$(this).css("color",i);$("#setKanBan .stateEl").addClass("hidden");$("#setKanBan .productEl").addClass("hidden");const t=kanBans.filter(t=>t.Type==n&&t.Id!=0);let r=0;const u=t.reduce((t,i)=>i.Id!==0&&i.Type==n?`${t}<option value=${i.Id}>${++r}-${i.Name}</option>`:"","");if($("#kanBanList").html(u),t.length>0){const n=t[0];$("#kanBanList").val(n.Id).trigger("select2:select")}});$("#kanBanItemColSet").on("input",".kb_item_col2",function(){let n=$(this).val()>>0;const r=$(this).attr("id");let t=0;$("#kanBanItemColSet .kb_item_col2").each((n,i)=>{let u=$(i).attr("id");r!=u&&(t+=$(i).val()>>0)});const i=100-t;n>i&&(n=i,$(this).val(n));initColSet(!1)});$("#kanBanContentCol").on("input",function(){const n=$(this).val();let t="";if(n>2){var i=getFirstOrders(n);t=`（首列顺序：${i.join()}）`;$("#kanBanItemColNameDiv").removeClass("hidden");initColName(!1)}else $("#kanBanItemColNameDiv").addClass("hidden");$("#kanBanContentColDesc").text(t)});$("#kanBanScript").on("input",".order",function(){const i=$(this).closest("tr"),n=$("#kanBanContentCol").val()>>0,t=getMaxSet(n);onInput(this,5,2,1,t)});$("#kanBanScript").on("input",".subOrder",function(){const n=$(this).closest("tr");onInput(this,5,2,1,5)});$("#kanBanItems").on("click",".itemAddBtn",function(){const t=$(this),n=$(t).attr("value").trim()>>0,f=t.attr("name"),i=colSet[0].chose.length,e=$("#kanBanList").val(),r=kanBans[e],o=kanBanItems[r.Type]?kanBanItems[r.Type]:[],u=o.filter(t=>t.Item==n);if(u.length>0){const t=u[0];addOrderData(t.FieldList);kanBanItemsTmp.push({Item:n,Col:0,Order:i,Shifts:0,Hour:0,Min:0,FieldList:t.FieldList});colSet[0].chose.push({name:f,val:n,col:0,order:i,height:100,dOrder:0,dField:t.FieldList.length?t.FieldList[0].Field:""});showPreProduct()}});$("#kanBanProductDetail").on("click",".itemDelBtn",function(){const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0;var n=($(t).find(`.C_${r}`).val()>>0)-1,i=($(t).find(`.O_${r}`).val()>>0)-1;removeArray(kanBanItemsTmp,"Col",n,"Order",i);kanBanItemsTmp.forEach(t=>{t.Col==n&&t.Order>=i&&t.Order--});removeArray(colSet[n].chose,"col",n,"order",i);colSet[n].chose=colSet[n].chose.sort(sortOrder);for(let t=0,i=colSet[n].chose.length;t<i;t++)colSet[n].chose[t].order=t;showPreProduct()});$("#kanBanProductDetail").on("click",".upTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t-1,colSet[n].chose[t-1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t-1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t-1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("click",".downTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t+1,colSet[n].chose[t+1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t+1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t+1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("change",".colSet",function(){var e,i;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,r=($(n).find(`.C_${t}`).attr("old")>>0)-1,nt=($(n).find(`.O_${t}`).attr("old")>>0)-1,u=($(n).find(`.C_${t}`).val()>>0)-1,f=($(n).find(`.O_${t}`).val()>>0)-1,v=$(n).find(`.N_${t}`).val().trim(),h=$(n).find(`.H_${t}`).val(),y=$(n).find(`.DF_${t}`).val(),p=$(n).find(`.DO_${t}`).val(),o=$(n).find(`.Time_${t}`).val()>>0,w=$(n).find(`.Range_${t}`).val()>>0,b=$(n).find(`.Step_${t}`).val()>>0,k=$(n).find(`.IsSum_${t}`).is(":checked");e=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(e)&&(e=[]);e=[].concat(e);const c=$(n).find(`.Shift_${t}`).val()>>0,d=$(n).find(`.Hour_${t}`).val()>>0,g=$(n).find(`.Min_${t}`).val()>>0;if(r==u)colSet[u].chose.forEach(n=>{n.order==f&&(n.name=v,n.dField=y,n.dOrder=p,n.height=isStrEmptyOrUndefined(h)?-1:h>>0)}),i=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f),kanBanItemsTmp.forEach(n=>{var t,r;n==i[0]&&(~its.indexOf(n.Item)?(n.ConfigList||(n.ConfigList=[]),t=0,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=c,n.ConfigList[t][1]=o,n.ConfigList[t][2]=w,n.ConfigList[t][3]=k?1:0,t=1,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=b,t=2,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==9&&(n.ConfigList[t]=e),t=3,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==11&&(n.ConfigList[t]=e),r="",o==0?r="hour":o==1?r="mDate":o==2?r="week":o==3?r="month":o==4&&(r="year"),n.FieldList&&n.FieldList.length&&(n.FieldList[0].Func=JSON.stringify({special:r}))):(n.Shifts=c,n.Hour=d,n.Min=g))});else{var i=colSet[r].chose.filter(n=>n.order==f),s=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==f),l=u,a=f;i.length&&s.length&&(removeArray(colSet[r].chose,"order",f),removeArray(kanBanItemsTmp,"Col",r,"Order",f),i[0].col=u,i[0].order=colSet[u].chose.length,colSet[u].chose.push(i[0]),l=i[0].col,a=i[0].order,s[0].Col=l,s[0].Order=a,kanBanItemsTmp.push(s[0]),colSet[r].chose.forEach((n,t)=>{if(n.order!=t){var i=kanBanItemsTmp.filter(t=>t.Col==r&&t.Order==n.order);kanBanItemsTmp.forEach(n=>{n==i[0]&&(n.Order=t)});n.order=t}}))}kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});i=0;$("#kanBanProductDetail").on("change ifChanged",".dOther",function(){var o;console.log(i++);const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,s=($(n).find(`.C_${t}`).attr("old")>>0)-1,e=($(n).find(`.C_${t}`).val()>>0)-1,h=($(n).find(`.O_${t}`).val()>>0)-1,u=$(n).find(`.Time_${t}`).val()>>0,c=$(n).find(`.Range_${t}`).val()>>0,l=$(n).find(`.Step_${t}`).val()>>0;var a=$(n).find(`.IsSum_${t}`).is(":checked"),f=$(n).find(`.IsCompare_${t}`).is(":checked"),r=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(r)&&(r=[]);r=[].concat(r);const v=$(n).find(`.Shift_${t}`).val()>>0;s==e&&(o=kanBanItemsTmp.filter(n=>n.Col==e&&n.Order==h),kanBanItemsTmp.forEach(i=>{var e,s;if(i==o[0]){if(i.ConfigList||(i.ConfigList=[]),e=0,i.ConfigList[e]||(i.ConfigList[e]=[]),i.ConfigList[e][0]=v,i.ConfigList[e][1]=u,u==0&&(f=!1),i.ConfigList[e][2]=c,i.ConfigList[e][4]=f?1:0,i.ConfigList[e][3]=a?1:0,f){$(n).find(`.compareDiv_${t}`).removeClass("hidden");const r=$(n).find(`.cTimeType_${t}`).val()>>0;s=i.ConfigList[e][5]!=r;i.ConfigList[e][5]=r;const f=$(n).find(`.cTimeRangeType_${t}`).val()>>0;if(i.ConfigList[e][6]=f,e=4,i.ConfigList[e]||(i.ConfigList[e]=[]),$(n).find(`.cTimeRangeType`).addClass("hidden"),f==0){$(n).find(`.cTimeRangeType_0_${t}`).removeClass("hidden");$(n).find(`.cTimeRangeType_02_${t}`).text(timeTypes[r]);const u=$(n).find(`.cTimeRangeType_01_${t}`).val()>>0;i.ConfigList[e][0]=u}else if(f==1){$(n).find(`.cTimeRangeType_1_${t}`).removeClass("hidden");let f=$(n).find(`.cTimeRangeType_11_${u}_${r}_${t}`).val();f=f?f:[];i.ConfigList[e]=f;$(n).find(`.cTimeRangeType_div`).addClass("hidden");$(n).find(`.cTimeRangeType_div_${u}_${r}_${t}`).removeClass("hidden")}else f==2}else $(n).find(`.compareDiv_${t}`).addClass("hidden");e=1;i.ConfigList[e]||(i.ConfigList[e]=[]);i.ConfigList[e][0]=l;e=2;i.ConfigList[e]||(i.ConfigList[e]=[]);i.Item==9&&(i.ConfigList[e]=r);e=3;i.ConfigList[e]||(i.ConfigList[e]=[]);i.Item==11&&(i.ConfigList[e]=r)}}))});$("#kanBanProductDetail").on("click",".sUpTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u-1),n.XvHao==t-1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t})}});showPreProduct()});$("#kanBanProductDetail").on("click",".sDownTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u+1),n.XvHao==t+1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t+1})}});showPreProduct()});$("#kanBanProductDetail").on("change",".cb",function(){var i,n;const r=$(this).closest(".kb_div1"),t=$(r).attr("display")>>0;if(t==0){i=$(this).prop("checked");const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0,u=($(t).find(`.C_${r}`).val()>>0)-1,f=($(t).find(`.O_${r}`).val()>>0)-1,e=$(this).closest("tr"),o=$(e).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f);kanBanItemsTmp.forEach(t=>{var u,r,f;t==n[0]&&(u=t.FieldList.length,t.FieldList.forEach(n=>{n.XvHao==o&&(n.Order=i?u+1:0)}),r=t.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r.forEach((n,t)=>{n.Order=t+1}),f=t.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao")),t.FieldList=r.concat(f),t.FieldList.forEach((n,t)=>{n.XvHao=t+1}))})}else if(t==1){const t=$(this).closest(".kb_div1"),i=$(t).attr("value")>>0,r=($(t).find(`.C_${i}`).val()>>0)-1,u=($(t).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),e=$(f).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(t=>{t==n[0]&&t.FieldList.forEach(n=>{n.Order=n.XvHao==e?1:0})})}showPreProduct()});$("#kanBanProductDetail").on("change",".fieldSet",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,r=($(n).find(`.C_${i}`).val()>>0)-1,u=($(n).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),t=$(f).attr("value")>>0,e=$(n).find(`.Com_${t}`).val(),o=$(n).find(`.Wid_${t}`).val(),s=$(n).find(`.Func_${t}`).val(),h=$(n).find(`.Pre_${t}`).val(),c=$(n).find(`.Suf_${t}`).val();var l=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(n=>{n==l[0]&&n.FieldList.forEach(n=>{n.XvHao==t&&(n.Column=e,n.Width=o,n.Func=unescape(s),n.Pre=h,n.Suffix=c)})})});var r=new Promise(n=>getWorkshop(n)),u=new Promise(n=>getStep(n)),f=new Promise(n=>getProduction(n)),e=new Promise(n=>getDevice(n)),o=new Promise(n=>getProcessor(n));r.then(()=>{Promise.all([u,f,e,o]).then(()=>{new Promise(n=>getKanBanList(n)).then(n=>{const i=n[0],t=n[1];t.length>0&&$("#kanBanList").trigger("select2:select")})})})}function initColName(n=true){let t=$("#kanBanContentCol").val()>>0;const u=$("#kanBanList").val(),i=kanBans[u];i&&(n&&(t=i.ContentCol),n&&(colName=i.ColName?i.ColName.split(","):[]));let r=colName.length;if(t>r)for(let n=colName.length,i=t;n<i;n++)colName[n]||(colName[n]="");else colName=sliceArray(colName,t);var f=Array.from($("#kanBanItemColName .kb_item_col2").map((n,t)=>t.value));for(let n=0,t=colName.length;n<t;n++){const t=f[n];t&&(colName[n]=t)}if(n){let n="";for(let i=0;i<t;i++){const t=colName[i];n+=`<div class="input-group kb_item_div1">
                    ...
                    </div>`,"");$("#kanBanItems").html(u)}function showPreProduct(){$("#kanBanProduct h3").text($("#kanBanName").val());const n=$("#kanBanType").val(),t=kanBanItems[n]?kanBanItems[n]:[],i=colSet.length,r=colSet.reduce((n,r)=>{r.chose=r.chose.sort(sortOrder);const u=r.chose.length,f=u>1?5:4,e=u>1?"":" hidden",o=r.chose.reduce((n,r,o)=>{var h,c,w;const b=t.filter(n=>n.Item==r.val),k=kanBanItemsTmp.filter(n=>n.Col==r.col&&n.Order==r.order);if(!b.length||!k.length)return n;const l=b[0],s=k[0],at=l.FieldList,v=s.FieldList,ot=v.filter(n=>n.Order).length,st=ot>1;var nt=0,a=0,it=10,rt=0,tt=0,d=0,y=0,p=[],ut=0,ft=[],et=[];let ht="",g="";if(~its.indexOf(l.Item)){s.ConfigList||(s.ConfigList=[]);h=0;c=0;s.ConfigList.length<=h&&(s.ConfigList=[]);s.ConfigList[h]||(s.ConfigList[h]=[]);c=0;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=nt);nt=s.ConfigList[h][c];c=1;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=a);a=s.ConfigList[h][c];c=2;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=it);it=s.ConfigList[h][c];c=3;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=rt);rt=s.ConfigList[h][c];c=4;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=tt);tt=s.ConfigList[h][c];c=5;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=d);d=s.ConfigList[h][c];c=6;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=y);y=s.ConfigList[h][c];h=1;s.ConfigList[h]||(s.ConfigList[h]=[]);c=0;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=ut);ut=s.ConfigList[h][c];h=2;s.ConfigList[h]||(s.ConfigList[h]=ft);ft=s.ConfigList[h];h=3;s.ConfigList[h]||(s.ConfigList[h]=et);et=s.ConfigList[h];h=4;s.ConfigList[h]||(s.ConfigList[h]=p);p=s.ConfigList[h];var ct=0,vt=[0,0];if(y==0?p.length&&(ct=p[0]):y==1?p.length>2&&(vt=p):y==2,w="",a==0?w="hour":a==1?w="mDate":a==2?w="week":a==3?w="month":a==4&&(w="year"),v&&v.length&&!v[0].Func&&(v[0].Func=JSON.stringify({special:w})),ht=setOptions(stepTmp,"StepName"),g+=`</br>
                    <label class="control-label">工序</label>
                    <select class="form-control dOther ms2m Step_${r.val}" value="${ut}">${ht}</select>`,l.Item!=10){let n="";l.Item==9?(n=setOptions(productionTmp,"ProductionProcessName"),g+=`计划号<select class="form-control dOther ms2 GroupItems_${r.val}" value="${ft.join()}">${n}</select>`):l.Item==11&&(n=setOptions(processorTmp,"Name"),g+=`操作工<select class="form-control dOther ms2m GroupItems_${r.val}" value="${et.join()}">${n}</select>`)}const n=timeTypes.reduce((n,t,i)=>i==0?n:n+timeUnderTypes(i).reduce((n,t,u)=>`${n}<div class="cTimeRangeType_div cTimeRangeType_div_${i}_${u}_${r.val} ${a==i&&d==u?"":"hidden"}">
                            <select class="form-control ms2 dOther cTimeRangeType_11_${i}_${u}_${r.val}" value="${p.join()}">
                                ${setOptionsArray(timeRanges(i,u))}
                            </select>
                        </div>`,""),"");g+=`<label class="control-label text-red">合计
                        <input type="checkbox" class="icb_minimal dOther cbs IsSum_${r.val}" value="${rt}">
                    </label>
                    ...
                    <div class="compareDiv_${r.val} ${a==0?"hidden":""}${tt==0?" hidden":""}">
                        ...
                        <div class="input-group${y==0?"":" hidden"} cTimeRangeType cTimeRangeType_0_${r.val}">
                            <input class="form-control text-center dOther cTimeRangeType_01_${r.val}" style="width: 70px;" value=${ct} oninput="onInput(this, 3, 0, 0, 24);">
                    ...
                    </div>`}else nt=k.length?s.Shifts:0;const yt=v.reduce((n,t,i)=>{const u=at.filter(n=>n.Field==t.Field),o=u.length?u[0].Column:"",s=u.length?u[0].Axis:0,f=u.length?u[0].DataType:"",p=!!FieldFunc[f],w=u.length?u[0].Special:"",b=p&&!!FieldFunc[f][w],e=t.Column?t.Column:"",h=t.Color?t.Color:"",c=t.Width?t.Width:"",a=t.Pre?t.Pre:"",v=t.Suffix?t.Suffix:"",y=t.Func?t.Func:"";return n+`<tr role="row" style="background-color: #f9f9f9;" value=${t.XvHao}>
                        <td style="padding: 4px; border: 1px solid gray;">
                            ${l.Display==1&&s==0?``:l.Display==1&&s==1?`<input type="radio" name="Radio_${r.col}_${r.order}" class="cb Cho_${i}" ${t.Order?"checked":""} value="0">`:`<input type="checkbox" class="cb Cho_${i}" ${t.Order?"checked":""} value="0">`}
                        </td>
                        ...
                        <td style="padding: 4px; border: 1px solid gray;">
                            <input class="form-control text-center no-padding fieldSet Wid_${i}" placeholder="自动" old=${c} value=${c}>
                        </td>
                        <td style="padding: 4px; border: 1px solid gray;">
                        ...
                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline Or_${i}" value=${t.Order}>
                            <span class="glyphicon glyphicon-arrow-up pointer text-green${i==0?" hidden":""} ${st&&t.Order?"":" hidden"} sUpTr" aria-hidden="true" title="上移"></span>
                            <span class="glyphicon glyphicon-arrow-down pointer text-red${i+1==ot?" hidden":""} ${st&&t.Order?"":" hidden"}   sDownTr" aria-hidden="true" title="下移"></span>
                        </td>`}
                    </tr>`},"");let lt="";return lt=~its.indexOf(l.Item)?workshopTmp[workshopId].ShiftNameList.reduce((n,t,i)=>`${n}<option value="${i+1}">${t}</option>`,'<option value="0">全天<\/option>'):setOptions(shifts,"Type"),`${n}<div class="kb_div1" style="height: ${r.height==-1?"auto":`${r.height}%`}" col="${r.col}" order="${r.order}" value="${r.val}" display="${l.Display}" >
                            ...
                            <table class="table table-striped no-margin">
                                ...
                                <tbody>
                                    <tr role="row" class="odd">
                                        ...
                                        ${!b[0].BShifts&&!b[0].BDuration?"":`<tr role="row" style="background-color: #f9f9f9;">
                                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline" colspan="${f}" >
                                            <div class="form-group form-inline">
                                            ${b[0].BShifts?`<label class="control-label">班制</label>
                                                <select class="form-control colSet Shift_${r.val}" value=${nt}>${lt}</select>`:""}
                                            ${b[0].BDuration?~its.indexOf(l.Item)?`<label class="control-label">时间类型</label>
                                                <select class="form-control colSet Time_${r.val}" value=${a}>${timeOptions}</select>
                                                <label class="control-label">时间范围</label>
                                                <div class="input-group">
                                                    <input class="form-control text-center colSet Range_${r.val}" style="width: 70px;" value=${it} oninput="onInput(this, 3, 0, 1, 24);">
        ...
        </div>`;if(carouselChose.length){const t=carouselChose.reduce((n,t)=>`${n}${carouselTmp[t.id].carouselLi}`,""),i=carouselChose.reduce((n,t)=>`${n}${carouselTmp[t.id].carouselTab}`,"");_carouselBox=n.format(t,i);carouselChose.forEach(n=>{page[n.id]=0,dsDivs[n.id]=[],dsPaths[n.id]=[]});carouselId=0;carouselIndex=0;$("#fullScreenCarousel").empty().append(_carouselBox);$("#fullScreenCarousel").find("ol li:first").addClass("active");$("#fullScreenCarousel").find(".item:first").addClass("active");$("#fullScreenCarousel").animate({top:0,opacity:1},1e3,"linear",()=>{});carouselFlag=$("#fullScreenCarousel .item:first").attr("id");setFullScreenCarousel(carouselFlag);$("#carousel-example-generic").carousel({interval:1e4}).off("slide.bs.carousel").on("slide.bs.carousel",n=>{if(carouselFlag=n.relatedTarget.id,carouselId=carouselFlag.replace("carousel_kanBan_",""),kanBans[carouselId]){if($(`#fullScreenCarousel .ftitle`).length&&$(`#fullScreenCarousel .ftitle`).text(` - ${kanBans[carouselId].Name}`),carouselFlag=="")return;setChart(carouselFlag,carouselId,kanBans[carouselId].Type,!0)}}).on("mouseenter",()=>$("#carousel-example-generic .isShow").removeClass("hidden")).on("mouseleave",()=>$("#carousel-example-generic .isShow").addClass("hidden")).on("mousemove",()=>{$("html").css({cursor:"default"}),checkMouseMove&&clearTimeout(checkMouseMove),checkMouseMove=setTimeout(function(){console.log("hide");$("html").css({cursor:"none"});$("#carousel-example-generic").trigger("mouseleave")},5e3)})}}function setFullScreenCarousel(){(clearInterval(carouselTime),carouselFlag!="")&&(carouselTime=setInterval(()=>{if(carouselId=carouselFlag.replace("carousel_kanBan_",""),kanBans[carouselId]){if($(`#fullScreenCarousel .ftitle`).text(` - ${kanBans[carouselId].Name}`),carouselFlag=="")return;setChart(carouselFlag,carouselId,kanBans[carouselId].Type,!0)}},5e3))}function cancelFullScreenCarousel(){kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))});checkMouseMove&&clearTimeout(checkMouseMove);clearInterval(carouselTime);carouselFlag="";$("#carousel-example-generic").carousel("pause").off("slide.bs.carousel mouseenter mouseleave");$("#fullScreenCarousel").animate({top:"-100%",opacity:0},1e3,"linear",function(){$(this).empty();fullScreen(!1)})}function setChart(n,t,i,r=false){var u,f;if(!run){run=!0;u=`#${n}`;const e=page[t]?page[t]:0;f={opType:509,opData:JSON.stringify({qId:t,page:e})};ajaxPost("/Relay/Post",f,e=>{var h,g,o,pt,oi,si,hi,wt,ci,bt,li,st,kt,dt,p,c,di,gi,ft,nr,gt,ht,ni,ct,tr,s,tt,l,ir,rr,ti,ur,d,a,ii,lt,at,ri,w,v,sr,ei,yt,ut,ot;run=!1;const it="text-red",rt="text-gray";if(pt=new Date,l||(l=e.time,tn=pt),l!=e.time&&(l=e.time,tn=pt),e.errno==0?(oi=$(`${u}_time`).text(),si=e.time,Math.abs(dateDiffSec(si,oi))>60?($(`${u}_time`).toggleClass(it),$(`${u}_time`).toggleClass(rt)&&$(`${u}_time`).removeClass(rt)):($(`${u}_time`).toggleClass(rt),$(`${u}_time`).hasClass(it)&&$(`${u}_time`).removeClass(it))):($(`${u}_time`).hasClass(it)||$(`${u}_time`).addClass(it),$(`${u}_time`).hasClass(rt)&&$(`${u}_time`).removeClass(rt),run=!1),o=e.data,i==1){if(e.errno!=0)return;hi=setPieChart(`${u}_detail`,"Rate",o.AllProcessRate,"#0099ff");$(`${u}_yxTime`).text(codeTime(o.RunTime));$(`${u}_jgTime`).text(codeTime(o.ProcessTime));$(`${u}_xzTime`).text(codeTime(o.IdleTime));$(`${u}_lly`).text(hi);wt=`${o.MaxUse}台`;ci=setPieChart(`${u}_max`,`Max
${wt}`,o.MaxUseRate,"#00a65a");$(`${u}_maxTs`).text(`${o.MaxSimultaneousUseRate}台`);$(`${u}_maxTNum`).text(wt);$(`${u}_maxSyl`).text(ci);bt=`${o.MinUse}台`;li=setPieChart(`${u}_min`,`Min
${bt}`,o.MinUseRate,"#f39c12");$(`${u}_minTs`).text(`${o.MinSimultaneousUseRate}台`);$(`${u}_minTNum`).text(bt);$(`${u}_minSyl`).text(li);var y=o.AllDevice,ai=o.NormalDevice,vi=o.ProcessDevice,yi=o.IdleDevice,pi=o.FaultDevice,wi=o.ConnectErrorDevice;for(setPieChart(`${u}_state_all`,`${y}台`,y/y,"green","总设备"),setPieChart(`${u}_state_normal`,`${ai}台`,ai/y,"blue","正常运行"),setPieChart(`${u}_state_process`,`${vi}台`,vi/y,"#0099ff","加工中"),setPieChart(`${u}_state_idle`,`${yi}台`,yi/y,"#cc33ff","闲置中"),setPieChart(`${u}_state_fault`,`${pi}台`,pi/y,"red","故障中"),setPieChart(`${u}_state_error`,`${wi}台`,wi/y,"#ff00cc","连接异常"),kt=o.UseCodeList||[],g="",h=0,st=kt.length;h<st;h++)g+=`<div style="border:1px solid;padding:5px 10px;margin:3px;border-radius:20%;background:#bfa;font-weight:bold">${kt[h]}</div>`;$(`${u}_dev`).empty().append(g||'<label style="color:red;font-size:18px">无<\/label>');var bi=o.SingleProcessRate,nt=[],ki=[];for(h=0,st=bi.length;h<st;h++)dt=bi[h],nt.push(dt.Code),ki.push((dt.Rate*100).toFixed(2));ut={tooltip:{trigger:"axis",formatter:"{a}<br/>{b} : {c}%",axisPointer:{type:"shadow"}},grid:{left:"3%",right:"3%",top:"6%",bottom:"8%",containLabel:!0},xAxis:{type:"category",axisLine:{onZero:!1},data:nt},yAxis:{name:"百分比",type:"value",scale:!0,axisLabel:{show:!0,formatter:"{value}%"}},series:{name:"利用率",type:"bar",areaStyle:{normal:{}},barWidth:"60%",label:{show:!0,position:"top",formatter:"{c}%"},itemStyle:{color:n=>n.value<30?"red":"green"},data:ki},dataZoom:[{type:"inside"},{handleIcon:_handleIcon,handleSize:"80%",handleStyle:{color:"#fff",shadowBlur:3,shadowColor:"rgba(0, 0, 0, 0.6)",shadowOffsetX:2,shadowOffsetY:2}}]};echarts.init($(`${u}_bar`)[0]).setOption(ut,!0);$(u).off("resize").on("resize",function(){clearTimeout(this.time);this.time=setTimeout(()=>{for(var t=$(this).find(".chart"),n=0,i=t.length;n<i;n++)echarts.init(t[n]).resize()},200)});p=o.ProductionList;const n=p.reduce((n,t)=>`${n}<td class="text-blue">${t.Code}</td>`,""),t=p.reduce((n,t)=>`${n}<td>${t.DayTotal}</td>`,""),i=p.reduce((n,t)=>`${n}<td>${t.DayQualified}</td>`,""),r=p.reduce((n,t)=>`${n}<td>${t.DayUnqualified}</td>`,""),f=p.reduce((n,t)=>`${n}<td>${t.DayQualifiedRate}%</td>`,""),s=p?p.filter(n=>n.DayTotal>0).length:0;$(`${u}_devs`).text(s);$(`${u}_pros`).text(o.DayTotal);$(`${u}_heGes`).text(o.DayQualified);$(`${u}_liePians`).text(o.DayUnqualified);$(`${u}_rates`).text(`${o.DayQualifiedRate}%`);$(`${u}_devOps`).find("td:not(:first)").remove().end().append(n);$(`${u}_proOps`).find("td:not(:first)").remove().end().append(t);$(`${u}_heGeOps`).find("td:not(:first)").remove().end().append(i);$(`${u}_liePianOps`).find("td:not(:first)").remove().end().append(r);$(`${u}_rateOps`).find("td:not(:first)").remove().end().append(f)}else if(i==2){if(c=`${u}_deviceState`,e.errno!=0){dsDivs[t].forEach(n=>{$(`#${n}`).addClass("hi")});$(`${c} .hi`).css("display","none").removeClass("hi");return}di=`<div id="{0}" class="kb_device_div1 ds" style="display:none;">
                    ...
                    <div style="top: 2%; height: 65%; position: relative;" id="{0}_detail"></div>
                            ...
                            </table>`}}return e}var a,v,f,o;if(n)for(l=n.length,h=0;h<l;h++)a=n[h],dsPaths[t][a.name]||(dsPaths[t][a.name]=a.path);const tt=Object.keys(dsPaths[t]).length;if(!(tt<=0)){for(v=[],s.forEach(n=>v[n.Id]=1),h=0;h<i;h++){const n=`${u}_ds${h}`;if(f=s[h],f){o="red";switch(f.DeviceStateStr){case"加工中":o="#00A65C";break;case"准备中":o="#ffd400";break;case"待机":case"流程升级中":case"固件升级中":case"设备重启中":case"连接正常":o="#f47920";break;case"已报修":case"已确认":case"维修中":o="red";break;default:o="gray"}const i=it(f.Data,e.cCol,e.cName);$(`${n}_img`).attr("src",dsPaths[t][f.Icon]);$(`${n}_code`).text(f.Code);$(`${n}_mc`).text(`${f.CategoryName}-${f.ModelName}`);$(`${n}_ws`).text(f.SiteName);$(`${n}_state`).css("background",o);$(`${n}_detail`).html(i);$(`${n}`).addClass("sh")}else $(`${n}`).addClass("hi")}$(`${c} .sh`).css("display","block").removeClass("sh");$(`${c} .hi`).css("display","none").removeClass("hi");$(`${u}_jg`).text(e.jg);$(`${u}_zb`).text(e.zb);$(`${u}_xz`).text(e.xz);$(`${u}_zc`).text(e.zc);$(`${u}_gz`).text(e.gz);$(`${u}_wlj`).text(e.wlj);$(`${u}_sum`).text(e.sum);var y=$(".ds"),p=y.length>0?($(y[0]).css("margin").replace("px","")>>0)*2:5,rt=($(c).css("padding").replace("px","")>>0)*2;if(e.row>0){var w=$(c).width(),b=Math.floor(w/(def+p)),ut=e.col>b?b:e.col,k=Math.floor(w/ut)-p,ft=$(window).height();$(`${u}`).css("height",`${ft}px`);var d=$(c).closest(".dsDiv").height(),g=Math.floor(d/def),et=e.row>g?g:e.row,nt=Math.floor(d/et)-rt;$(".ds").css("flex-basis",`${k<def?def:k}px`).css("height",`${nt<def?def:nt}px`)}r&&(page[t]=++e.cp)}};const a=[];for(h=0;h<l;h++)ht=s[h],dsPaths[t][ht.Icon]||~a.lastIndexOf(ht.Icon)||a.push(ht.Icon);if(a.length>0){f={type:fileEnum.Device,files:JSON.stringify(a)};f.dir="";for(ni in fileEnum)if(fileEnum[ni]==f.type){f.dir=ni;break}if(isStrEmptyOrUndefined(f.dir))return void layer.msg("文件类型不存在！");getFilePath(f,gt,0)}else gt()}else if(i==3){if(e.errno!=0)return;if(!e.data)return;var o=e.data,hr=e.colSet?JSON.parse(e.colSet):[],cr=`${u}_productDiv`,ft=$(window).height(),lr=$(`${u} .kb_title1`).closest("div").height()>>0;for($(`${cr}`).css("height",`${ft-lr}px`),ct=0,tr=e.items.length;ct<tr;ct++){const t=e.items[ct],y=t.Item,r=kanBanItems[i][y],h=hr[t.Col].chose[t.Order];if(t&&r&&h){const p=r.FieldList?r.FieldList:[],c=[];p.forEach(n=>{c[n.Field]=n});const g=t.FieldList?t.FieldList:[],f=g.filter(n=>n.Order).sort(firstBy("Order"));if(f&&f.length){const e=`${t.Item}_${t.Col}_${t.Order}`,i=`${u}_${t.Col}_${t.Order}`,it=$(`${i}`).closest(".kb_border2").height(),ft=$(`${i}`).closest(".kb_border2").find("h4").height(),rt=it-ft;if($(`${i}`).closest(".table-responsive").css("height",`${Math.floor(rt*100/it)}%`),$(`${i}`).closest(".kb_border2").find(".tt1").text(h.name),!o.hasOwnProperty(e))continue;if(s=o[e],r.Display==0){const e=h.dOrder=="0"?"asc":"desc";s=s.sort(firstBy(h.dField,e));$(`${i}`).closest(".kb_border2").find(".tt2").text(`(${s.length})`);addOrderData(s);let u=$(`${i} tbody tr`);if(u.length){const n=$(`${i} tr[class='max']`),h=$(n).attr("order")>>0;let o=!1;if(u.each((n,t)=>{const i=$(t).attr(trFlag),r=s.filter(n=>n[trFlag]==i);r.length||($(t).remove(),o=!0)}),o&&u.length>0&&(u=$(`${i} tbody tr`),tt=[],u.each((n,t)=>{var i=$(t).attr(trFlag)>>0;tt[i]=t}),l=Object.values(tt),l.forEach((n,t)=>{$(n).attr("order",t+1);$(n).attr(trFlag,t+1);var i="";(e=="asc"&&s.length==t+1||e=="desc"&&t==0)&&(i=`max`,$(n).addClass(i))}),u=$(`${i} tbody tr`)),!o){const i=s.length-u.length;if(s.length>u.length){n.removeClass("max");let f=[];f=e=="asc"?sliceArray(s,i,u.length):sliceArray(s,i,0);const o=getItemTrs(f,r,t,e);e=="asc"?n.after(o):n.before(o)}let o=[];o=e=="asc"?sliceArray(s,u.length,0):sliceArray(s,s.length,i);tt=[];u.each((n,t)=>{var i=$(t).attr(trFlag)>>0;tt[i]=t});l=Object.values(tt);l.length&&l.forEach((n,t)=>{var i,a,h;const l=o[t],r=$(n),v=f.filter(n=>n.Field=="XvHao");for(v.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),i=0,a=f.length;i<a;i++){const n=f[i];var s=l[n.Field],y=n.Pre?n.Pre:"",p=n.Suffix?n.Suffix:"",w=n.Width&&n.Width!=="auto"?`width: ${n.Width}px;`:`width: auto;`,e="",u="";if(c[n.Field]&&n.Func){const t=JSON.parse(n.Func);if(t.color==1?u=n.Color:t.color==2&&t.cons.every(n=>meetCondition(s,n.con,n.conv)?(u=n.color,!1):!0),t.special){const i=c[n.Field].DataType;s=FieldFunc[i][t.special].func(s)}t.bold&&(e="text-bold")}u=u?`color: ${u};`:`color: "";`;const o=`${y}${s}${p}`,t=l.XvHao,a=$(r.find("td")[i]).text(),v=$(r).attr("order")>>0;a!=o&&$(r.find("td")[i]).html(o);v!=t&&($(r).attr("XvHao",t),$(r).attr("order",t));h=$(r.find("td")[i]).hasClass("text-bold");e&&!h?$(r.find("td")[i]).addClass(e):!e&&h&&$(r.find("td")[i]).removeClass(e);$(r.find("td")[i]).attr("style",w);$(r.find("td")[i]).attr("style",u)}})}}else s.length&&$(`${i} tbody`).html(getItemTrs(s,r,t,e));ir=$(`${i} tr`).height();rr=rt-$(`${i} tbody`).closest(".kb_item_tablebox").css("padding").replace("px","")*2;u=$(`${i} tbody tr`);ti=Math.floor(rr/ir)-1;const o=`${n}_${t.Col}_${t.Order}_timer`;u.length>ti&&!kanBanProductItemsEl[o]?scrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`):u.length<=ti&&(ur=getItemTrs(s,r,t,e),$(`${i} tbody`).html(ur),kanBanProductItemsEl[o]&&stopScrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`))}else if(r.Display==1){if(!s.length)continue;if(!f.length)continue;d=f[0];a="";switch(r.DisplayType){case 0:a="line";break;case 1:a="bar";break;case 2:a="pie"}if(isStrEmptyOrUndefined(a))continue;if(ii=p.filter(n=>n.Axis==0),!ii.length)continue;lt=ii[0];at=lt.Field;const n=h.dOrder=="0"?"asc":"desc";if(s=s.sort(firstBy(h.dField,n)),ri=g.filter(n=>n.Field==at),!ri.length)continue;var et=ri[0],ui=null,fr=null,fi=null,vt=0,er=0,or=0;if(~its.indexOf(y)&&et.Func){const n=JSON.parse(et.Func);n.special&&(ui=FieldFunc[lt.DataType][n.special].func,fr=1,t.ConfigList&&(w=0,t.ConfigList.length>w&&(v=1,t.ConfigList[w].length>v&&(vt=t.ConfigList[w][v]),fi=timeTypes[vt],v=4,t.ConfigList[w].length>v&&(er=t.ConfigList[w][v]),v=5,t.ConfigList[w].length>v&&(or=t.ConfigList[w][v]))))}var nt=distinct(s.map(n=>ui?ui(n[at],fr):n[at])),b=[],k=distinct(s.map(n=>n.Data).filter(n=>n));er?(ei=CompareTimeFunc[timeTypes[vt]][timeTypes[or]].func,yt=distinct(s.map(n=>ei(n[et.Field],1)).filter(n=>n)),k.length?yt.forEach(n=>{var t=s.filter(t=>CompareTimeFunc[timeTypes[vt]][special].func(t[et.Field])==n).map(n=>n[d.Field]);b.push({name:n,type:a,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:t})}):yt.forEach(n=>{var t=s.filter(t=>ei(t[et.Field],1)==n).map(n=>n[d.Field]);b.push({name:n,type:a,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:t})}),k=yt):k.length?k.forEach(n=>{var t=s.filter(t=>t.Data==n).map(n=>n[d.Field]);b.push({name:n,type:a,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:t})}):(sr=s.map(n=>n[d.Field]),b.push({type:a,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:sr}));ut={tooltip:{trigger:"axis"},grid:{left:"3%",right:"6%",bottom:"3%",containLabel:!0},color:["#00a65a","red","#ff00ff","#cc3300","#ff9900","#9933ff","blue","#0099ff","#660066"],xAxis:{name:fi?fi:lt.Field,nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"category",boundaryGap:!1,data:nt,axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:19}}},yAxis:{name:d?d.Column:"",nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"value",axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:16}}},legend:{data:k,textStyle:{color:"white",fontWeight:"bold",fontSize:16}},series:b};pTableOrChart[i]?(ot=!1,isEqual(pTableOrChart[i].lData,k)||(ot=!0),isEqual(pTableOrChart[i].xData,nt)||(ot=!0),isEqual(pTableOrChart[i].series,b)||(ot=!0),ot&&(pTableOrChart[i].chart.setOption(ut,!0),pTableOrChart[i].lData=k,pTableOrChart[i].xData=nt,pTableOrChart[i].series=b)):(pTableOrChart[i]={lData:k,xData:nt,series:b,chart:echarts.init($(i)[0])},pTableOrChart[i].chart.setOption(ut,!0),$(i).resize(function(){for(var n in pTableOrChart){const t=pTableOrChart[n];t.chart&&t.chart.resize()}}))}}}}}},0)}}function getItemTrs(n,t,i,r){const u=[];t.FieldList&&t.FieldList.forEach(n=>{u[n.Field]=n});const f=i.FieldList?i.FieldList.filter(n=>n.Order):[],e=f.filter(n=>n.Field=="XvHao");return e.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),n.reduce((t,i,e)=>{const s=f.reduce((n,t,r)=>{var e=i[t.Field],h=t.Pre?t.Pre:"",c=t.Suffix?t.Suffix:"",l=t.Width&&t.Width!=="auto"?`width: ${t.Width}px;`:`width: auto;`,o="",f="",r,s;if(u[t.Field]&&t.Func){const n=JSON.parse(t.Func);if(n.color==1)f=t.Color;else if(n.color==2)for(r=0,s=n.cons.length;r<s;r++){const t=n.cons[r];if(meetCondition(e,t.con,t.conv)){f=t.color;break}}if(n.special){const i=u[t.Field].DataType;e=FieldFunc[i][n.special].func(e)}n.bold&&(o="text-bold")}return f=f?`color: ${f};`:``,n+`<td class="${o}" style='${l}${f}'>${h}${e}${c}</td>`},"");var o="";return(r=="asc"&&n.length==e+1||r=="desc"&&e==0)&&(o=` class="max"`),t+`<tr${o} order=${i.XvHao} ${trFlag}=${i[trFlag]}>${s}</tr>`},"")}function setPieChart(n,t,i,r,u){i=i||0;var e=`${(i*100).toFixed(2)}%`,f={color:["#cdcdcd",r],series:{type:"pie",center:["50%","50%"],radius:["65%","100%"],hoverAnimation:!1,animation:!1,silent:!0,label:{show:!0,position:"center",formatter:`${t}
