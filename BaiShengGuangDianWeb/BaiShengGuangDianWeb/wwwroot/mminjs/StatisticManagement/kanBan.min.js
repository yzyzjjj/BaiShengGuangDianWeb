function pageReady(){var n;$(".sidebar-mini").addClass("sidebar-collapse");_permissionList[675]={uIds:[]};_permissionList[676]={uIds:["firstNavLi","setKanBan"]};_permissionList[722]={uIds:["setTab","setTabLi"]};_permissionList[723]={uIds:["carouselTab","carouselTabLi"]};_permissionList=checkPermissionUi(_permissionList);!_permissionList[722].have&&_permissionList[723].have&&$("#carouselTabLi a").click();$("#kanBanList").select2();$("#deviceSelect").select2({allowClear:!0,placeholder:"请选择",multiple:!0});$("#navUl").on("click","a",function(){var n=$(this).attr("href").replace("#",""),f=n.replace("kanBan_","");const u=parseInt(f);if(curId!=u){curId=u;let r=-1;const i=kanBans[curId];i&&(r=i.Type);timeEl=n;r==2&&$(`#${n}_deviceState`).empty();curId>-1?(dsDivs[curId]=[],dsPaths[curId]=[],page[curId]=0,setChart(n,curId,r),clearInterval(uiTime),clearInterval(dataTime),t=(i.UI<1?1:i.UI)*1e3,uiTime=setInterval(()=>{run||setChart(n,curId,r,!0)},t),t=(i.Second<1?1:i.Second)*1e3,dataTime=setInterval(()=>{run||setChart(n,curId,r)},t)):(kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))}),clearInterval(uiTime),clearInterval(dataTime))}});$(".content").on("click",".fullScreenBtn",function(){var t=`#${$(this).attr("target")}`,n;$(t).toggleClass("panel-fullscreen");n=$(t).hasClass("panel-fullscreen");$(this).toggleClass("glyphicon-fullscreen glyphicon-repeat").prop("title",n?"还原":"全屏放大");n?$(this).addClass("fsb"):$(this).removeClass("fsb");fullScreen(n);n||kanBanProductItemsEl.forEach(n=>{for(var t in n)~t.indexOf("_timer")&&stopScrollTable(n,t,t.replace("_timer",""))})});setInterval(()=>{$(`#${timeEl}_time`).length>0&&$(`#${timeEl}_time`).text(getFullTime()),$(`#${carouselFlag}_time`).length>0&&$(`#${carouselFlag}_time`).text(getFullTime())},1e3);n=function(){$("#kanBanLength").val(($("#kanBanRow").val()>>0)*($("#kanBanCol").val()>>0));let n=$(this).val()>>0;n==0&&(n=1,$(this).val(n));n>15&&(n=15,$(this).val(n));const t=$("#kanBanType").val()>>0;t==3&&initColSet(!1)};$("#kanBanRow").on("input",n);$("#kanBanCol").on("input",n);$("#kanBanList").on("select2:select",function(){var t=$(this).val(),n,i,r;t&&(n=kanBans[t],$("#kanBanName").val(n.Name),$("#kanBanOrder").val(n.Order),$("#isShow").iCheck(n.IsShow?"check":"uncheck"),$("#setKanBan .stateEl").addClass("hidden"),$("#setKanBan .stateEl1").addClass("hidden"),$("#setKanBan .productEl").addClass("hidden"),$("#kanBanUI").val(n.UI),$("#kanBanSecond").val(n.Second),n.Type==2?($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#kanBanContentCol").val(n.ContentCol),$("#kanBanLength").val(n.Length),$("#setKanBan .stateEl").removeClass("hidden"),scriptIndexTmp=[],scriptTmp=[],n.ContentCol>2&&($("#kanBanItemColNameDiv").removeClass("hidden"),i=getFirstOrders(n.ContentCol),r=`（首列：${i.join()},不为空的列名）`,$("#kanBanContentColDesc").text(r),initColName(!0)),$("#kanBanScript").html("")):n.Type==3&&($("#kanBanRow").val(n.Row),$("#kanBanCol").val(n.Col),$("#setKanBan .productEl").removeClass("hidden"),initColSet(!0),initProduct(n.Type),showPreProduct()),$("#deviceSelect").val(n.DeviceIdList).trigger("change"))});$("#deviceSelect").on("select2:select",function(){var n=$(this).val();~n.indexOf("0")&&$(this).val(0).trigger("change")}).on("change",function(){let n=$(this).val();if(isStrEmptyOrUndefined(n)){scriptIndexTmp=[];scriptTmp=[];$("#kanBanScript").html("");return}var t=[];n.length==1&&~n.indexOf("0")&&(n=deviceTmp.map(n=>n.Id).filter(n=>n));const i=$("#kanBanType").val()>>0;i==2&&(n.forEach(n=>{if(n!=0){var i=deviceTmp[n].ScriptId;~t.indexOf(i)||t.push(i);~scriptIndexTmp.indexOf(i)?existArrayObj(scriptTmp[i].ds,"id",n)||scriptTmp[i].ds.push({id:n,code:deviceTmp[n].Code}):(scriptIndexTmp.push(i),scriptTmp[i]={sId:i,sName:deviceTmp[n].ScriptName,ds:[{id:n,code:deviceTmp[n].Code}]})}}),scriptIndexTmp=t,scriptTmp.forEach(t=>{const i=t.sId;if(~scriptIndexTmp.indexOf(i)){const t=scriptTmp[i].ds.map(n=>n.id);t.forEach(t=>{~n.indexOf(t)||removeArray(scriptTmp[i].ds,"id",t)});scriptTmp[i].ds.length==0&&delete scriptTmp[i]}else scriptTmp[i].div&&$(`#${scriptTmp[i].div}`).remove(),delete scriptTmp[i]}),getScriptList())});$("#kanBanType").on("change",function(){const n=$(this).val(),i=$(this).find(`[value=${n}]`).css("color");$(this).css("color",i);$("#setKanBan .stateEl").addClass("hidden");$("#setKanBan .productEl").addClass("hidden");const t=kanBans.filter(t=>t.Type==n&&t.Id!=0);let r=0;const u=t.reduce((t,i)=>i.Id!==0&&i.Type==n?`${t}<option value=${i.Id}>${++r}-${i.Name}</option>`:"","");if($("#kanBanList").html(u),t.length>0){const n=t[0];$("#kanBanList").val(n.Id).trigger("select2:select")}});$("#kanBanItemColSet").on("input",".kb_item_col2",function(){let n=$(this).val()>>0;const r=$(this).attr("id");let t=0;$("#kanBanItemColSet .kb_item_col2").each((n,i)=>{let u=$(i).attr("id");r!=u&&(t+=$(i).val()>>0)});const i=100-t;n>i&&(n=i,$(this).val(n));initColSet(!1)});$("#kanBanContentCol").on("input",function(){const n=$(this).val();let t="";if(n>2){var i=getFirstOrders(n);t=`（首列顺序：${i.join()}）`;$("#kanBanItemColNameDiv").removeClass("hidden");initColName(!1)}else $("#kanBanItemColNameDiv").addClass("hidden");$("#kanBanContentColDesc").text(t)});$("#kanBanScript").on("input",".order",function(){const i=$(this).closest("tr"),n=$("#kanBanContentCol").val()>>0,t=getMaxSet(n);onInput(this,5,2,1,t)});$("#kanBanScript").on("input",".subOrder",function(){const n=$(this).closest("tr");onInput(this,5,2,1,5)});$("#kanBanItems").on("click",".itemAddBtn",function(){const t=$(this),n=$(t).attr("value").trim()>>0,f=t.attr("name"),i=colSet[0].chose.length,e=$("#kanBanList").val(),r=kanBans[e],o=kanBanItems[r.Type]?kanBanItems[r.Type]:[],u=o.filter(t=>t.Item==n);if(u.length>0){const t=u[0];addOrderData(t.FieldList);kanBanItemsTmp.push({Item:n,Col:0,Order:i,Shifts:0,Hour:0,Min:0,FieldList:t.FieldList});colSet[0].chose.push({name:f,val:n,col:0,order:i,height:100,dOrder:0,dField:t.FieldList.length?t.FieldList[0].Field:""});showPreProduct()}});$("#kanBanProductDetail").on("click",".itemDelBtn",function(){const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0;var n=($(t).find(`.C_${r}`).val()>>0)-1,i=($(t).find(`.O_${r}`).val()>>0)-1;removeArray(kanBanItemsTmp,"Col",n,"Order",i);kanBanItemsTmp.forEach(t=>{t.Col==n&&t.Order>=i&&t.Order--});removeArray(colSet[n].chose,"col",n,"order",i);colSet[n].chose=colSet[n].chose.sort(sortOrder);for(let t=0,i=colSet[n].chose.length;t<i;t++)colSet[n].chose[t].order=t;showPreProduct()});$("#kanBanProductDetail").on("click",".upTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t-1,colSet[n].chose[t-1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t-1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t-1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("click",".downTr",function(){const i=$(this).closest(".kb_div1"),r=$(i).attr("value")>>0,n=($(i).find(`.C_${r}`).val()>>0)-1,t=($(i).find(`.O_${r}`).val()>>0)-1;colSet[n]&&colSet[n].chose&&(colSet[n].chose[t].order=t+1,colSet[n].chose[t+1].order=t,colSet[n].chose=colSet[n].chose.sort(sortOrder));var u=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t),f=kanBanItemsTmp.filter(i=>i.Col==n&&i.Order==t+1);kanBanItemsTmp.forEach(n=>{n==u[0]&&(n.Order=t+1),n==f[0]&&(n.Order=t)});kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("change",".colSet",function(){var o,i;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,r=($(n).find(`.C_${t}`).attr("old")>>0)-1,nt=($(n).find(`.O_${t}`).attr("old")>>0)-1,u=($(n).find(`.C_${t}`).val()>>0)-1,f=($(n).find(`.O_${t}`).val()>>0)-1,v=$(n).find(`.N_${t}`).val().trim(),h=$(n).find(`.H_${t}`).val(),y=$(n).find(`.DF_${t}`).val(),p=$(n).find(`.DO_${t}`).val(),e=$(n).find(`.Time_${t}`).val()>>0,w=$(n).find(`.Range_${t}`).val()>>0,b=$(n).find(`.Step_${t}`).val()>>0,k=$(n).find(`.IsSum_${t}`).is(":checked");o=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(o)&&(o=[]);const c=$(n).find(`.Shift_${t}`).val()>>0,d=$(n).find(`.Hour_${t}`).val()>>0,g=$(n).find(`.Min_${t}`).val()>>0;if(r==u)colSet[u].chose.forEach(n=>{n.order==f&&(n.name=v,n.dField=y,n.dOrder=p,n.height=isStrEmptyOrUndefined(h)?-1:h>>0)}),i=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f),kanBanItemsTmp.forEach(n=>{var t,r;n==i[0]&&(~its.indexOf(n.Item)?(n.ConfigList||(n.ConfigList=[]),t=0,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=c,n.ConfigList[t][1]=e,n.ConfigList[t][2]=w,n.ConfigList[t][3]=k?1:0,t=1,n.ConfigList[t]||(n.ConfigList[t]=[]),n.ConfigList[t][0]=b,t=2,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==9&&(n.ConfigList[t]=o),t=3,n.ConfigList[t]||(n.ConfigList[t]=[]),n.Item==11&&(n.ConfigList[t]=o),r="",e==0?r="hour":e==1?r="mDate":e==2?r="week":e==3?r="month":e==4&&(r="year"),n.FieldList&&n.FieldList.length&&(n.FieldList[0].Func=JSON.stringify({special:r}))):(n.Shifts=c,n.Hour=d,n.Min=g))});else{var i=colSet[r].chose.filter(n=>n.order==f),s=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==f),l=u,a=f;i.length&&s.length&&(removeArray(colSet[r].chose,"order",f),removeArray(kanBanItemsTmp,"Col",r,"Order",f),i[0].col=u,i[0].order=colSet[u].chose.length,colSet[u].chose.push(i[0]),l=i[0].col,a=i[0].order,s[0].Col=l,s[0].Order=a,kanBanItemsTmp.push(s[0]),colSet[r].chose.forEach((n,t)=>{if(n.order!=t){var i=kanBanItemsTmp.filter(t=>t.Col==r&&t.Order==n.order);kanBanItemsTmp.forEach(n=>{n==i[0]&&(n.Order=t)});n.order=t}}))}kanBanItemsTmp=kanBanItemsTmp.sort(firstBy("Col").thenBy("Order"));showPreProduct()});$("#kanBanProductDetail").on("change",".dOther",function(){var i,f;const n=$(this).closest(".kb_div1"),t=$(n).attr("value")>>0,e=($(n).find(`.C_${t}`).attr("old")>>0)-1,r=($(n).find(`.C_${t}`).val()>>0)-1,o=($(n).find(`.O_${t}`).val()>>0)-1,s=$(n).find(`.Time_${t}`).val()>>0,h=$(n).find(`.Range_${t}`).val()>>0,c=$(n).find(`.Step_${t}`).val()>>0,l=$(n).find(`.IsSum_${t}`).is(":checked"),u=$(n).find(`.IsCompare_${t}`).is(":checked");i=$(n).find(`.GroupItems_${t}`).val();isStrEmptyOrUndefined(i)&&(i=[]);const a=$(n).find(`.Shift_${t}`).val()>>0;e==r&&(f=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==o),kanBanItemsTmp.forEach(r=>{if(r==f[0]){r.ConfigList||(r.ConfigList=[]);var e=0;if(r.ConfigList[e]||(r.ConfigList[e]=[]),r.ConfigList[e][0]=a,r.ConfigList[e][1]=s,r.ConfigList[e][2]=h,r.ConfigList[e][3]=l?1:0,r.ConfigList[e][4]=u?1:0,u){const u=$(n).find(`.cTimeType_${t}`).val()>>0;r.ConfigList[e][5]=u;const i=$(n).find(`.cTimeRange_${t}`).val()>>0;r.ConfigList[e][6]=i;i==0||i==1||i==2}e=1;r.ConfigList[e]||(r.ConfigList[e]=[]);r.ConfigList[e][0]=c;e=2;r.ConfigList[e]||(r.ConfigList[e]=[]);r.Item==9&&(r.ConfigList[e]=i);e=3;r.ConfigList[e]||(r.ConfigList[e]=[]);r.Item==11&&(r.ConfigList[e]=i)}}))});$("#kanBanProductDetail").on("click",".sUpTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u-1),n.XvHao==t-1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t})}});showPreProduct()});$("#kanBanProductDetail").on("click",".sDownTr",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,f=($(n).find(`.C_${i}`).val()>>0)-1,e=($(n).find(`.O_${i}`).val()>>0)-1,r=$(this).closest("tr"),t=$(r).attr("value")>>0,u=$(r).find(`.Or_${t}`).attr("value")>>0;var o=kanBanItemsTmp.filter(n=>n.Col==f&&n.Order==e);kanBanItemsTmp.forEach(n=>{if(n==o[0]){n.FieldList.forEach(n=>{n.XvHao==t&&(n.Order=u+1),n.XvHao==t+1&&(n.Order=u)});var i=n.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r=n.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao"));n.FieldList=i.concat(r);n.FieldList.forEach((n,t)=>{n.XvHao=t+1})}});showPreProduct()});$("#kanBanProductDetail").on("change",".cb",function(){var i,n;const r=$(this).closest(".kb_div1"),t=$(r).attr("display")>>0;if(t==0){i=$(this).prop("checked");const t=$(this).closest(".kb_div1"),r=$(t).attr("value")>>0,u=($(t).find(`.C_${r}`).val()>>0)-1,f=($(t).find(`.O_${r}`).val()>>0)-1,e=$(this).closest("tr"),o=$(e).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==u&&n.Order==f);kanBanItemsTmp.forEach(t=>{var u,r,f;t==n[0]&&(u=t.FieldList.length,t.FieldList.forEach(n=>{n.XvHao==o&&(n.Order=i?u+1:0)}),r=t.FieldList.filter(n=>n.Order).sort(firstBy("Order")),r.forEach((n,t)=>{n.Order=t+1}),f=t.FieldList.filter(n=>!n.Order).sort(firstBy("XvHao")),t.FieldList=r.concat(f),t.FieldList.forEach((n,t)=>{n.XvHao=t+1}))})}else if(t==1){const t=$(this).closest(".kb_div1"),i=$(t).attr("value")>>0,r=($(t).find(`.C_${i}`).val()>>0)-1,u=($(t).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),e=$(f).attr("value")>>0;n=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(t=>{t==n[0]&&t.FieldList.forEach(n=>{n.Order=n.XvHao==e?1:0})})}showPreProduct()});$("#kanBanProductDetail").on("change",".fieldSet",function(){const n=$(this).closest(".kb_div1"),i=$(n).attr("value")>>0,r=($(n).find(`.C_${i}`).val()>>0)-1,u=($(n).find(`.O_${i}`).val()>>0)-1,f=$(this).closest("tr"),t=$(f).attr("value")>>0,e=$(n).find(`.Com_${t}`).val(),o=$(n).find(`.Wid_${t}`).val(),s=$(n).find(`.Func_${t}`).val(),h=$(n).find(`.Pre_${t}`).val(),c=$(n).find(`.Suf_${t}`).val();var l=kanBanItemsTmp.filter(n=>n.Col==r&&n.Order==u);kanBanItemsTmp.forEach(n=>{n==l[0]&&n.FieldList.forEach(n=>{n.XvHao==t&&(n.Column=e,n.Width=o,n.Func=unescape(s),n.Pre=h,n.Suffix=c)})})});var i=new Promise(n=>getWorkshop(n)),r=new Promise(n=>getStep(n)),u=new Promise(n=>getProduction(n)),f=new Promise(n=>getDevice(n)),e=new Promise(n=>getProcessor(n));i.then(()=>{Promise.all([r,u,f,e]).then(()=>{new Promise(n=>getKanBanList(n)).then(n=>{const i=n[0],t=n[1];t.length>0&&$("#kanBanList").trigger("select2:select")})})})}function initColName(n=true){let t=$("#kanBanContentCol").val()>>0;const u=$("#kanBanList").val(),i=kanBans[u];i&&(n&&(t=i.ContentCol),n&&(colName=i.ColName?i.ColName.split(","):[]));let r=colName.length;if(t>r)for(let n=colName.length,i=t;n<i;n++)colName[n]||(colName[n]="");else colName=sliceArray(colName,t);var f=Array.from($("#kanBanItemColName .kb_item_col2").map((n,t)=>t.value));for(let n=0,t=colName.length;n<t;n++){const t=f[n];t&&(colName[n]=t)}if(n){let n="";for(let i=0;i<t;i++){const t=colName[i];n+=`<div class="input-group kb_item_div1">
                    ...
                    </div>`,"");$("#kanBanItems").html(u)}function showPreProduct(){$("#kanBanProduct h3").text($("#kanBanName").val());const n=$("#kanBanType").val(),t=kanBanItems[n]?kanBanItems[n]:[],i=colSet.length,r=colSet.reduce((n,r)=>{r.chose=r.chose.sort(sortOrder);const u=r.chose.length,f=u>1?5:4,e=u>1?"":" hidden",o=r.chose.reduce((n,r,o)=>{var h,c,p;const w=t.filter(n=>n.Item==r.val),b=kanBanItemsTmp.filter(n=>n.Col==r.col&&n.Order==r.order);if(!w.length||!b.length)return n;const l=w[0],s=b[0],lt=l.FieldList,y=s.FieldList,et=y.filter(n=>n.Order).length,ot=et>1;var d=0,a=0,tt=10,it=0,g=0,st=0,v=0,ht=[],nt=0,rt=[],ut=[];let ft="",k="";if(~its.indexOf(l.Item)){s.ConfigList||(s.ConfigList=[]);h=0;c=0;s.ConfigList.length<=h&&(s.ConfigList=[]);s.ConfigList[h]||(s.ConfigList[h]=[]);c=0;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=d);d=s.ConfigList[h][c];c=1;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=a);a=s.ConfigList[h][c];c=2;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=tt);tt=s.ConfigList[h][c];c=3;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=it);it=s.ConfigList[h][c];c=4;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=g);g=s.ConfigList[h][c];c=5;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=st);st=s.ConfigList[h][c];c=6;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=v);v=s.ConfigList[h][c];h=1;s.ConfigList[h]||(s.ConfigList[h]=[]);c=0;s.ConfigList[h].length<=c&&(s.ConfigList[h][c]=nt);nt=s.ConfigList[h][c];h=2;s.ConfigList[h]||(s.ConfigList[h]=rt);rt=s.ConfigList[h];h=3;s.ConfigList[h]||(s.ConfigList[h]=ut);ut=s.ConfigList[h];h=4;s.ConfigList[h]||(s.ConfigList[h]=ht);ht=s.ConfigList[h];if(v==0||v==1||v==2,p="",a==0?p="hour":a==1?p="mDate":a==2?p="week":a==3?p="month":a==4&&(p="year"),y&&y.length&&!y[0].Func&&(y[0].Func=JSON.stringify({special:p})),ft=setOptions(stepTmp,"StepName"),k+=`</br>
                    <label class="control-label">工序</label>
                    <select class="form-control dOther ms2m Step_${r.val}" value="${nt}">${ft}</select>`,l.Item!=10){let n="";l.Item==9?(n=setOptions(productionTmp,"ProductionProcessName"),k+=`计划号<select class="form-control dOther ms2 GroupItems_${r.val}" value="${rt.join()}">${n}</select>`):l.Item==11&&(n=setOptions(processorTmp,"Name"),k+=`操作工<select class="form-control dOther ms2m GroupItems_${r.val}" value="${ut.join()}">${n}</select>`)}k+=`<label class="control-label text-red">合计
                        <input type="checkbox" class="icb_minimal dOther cbs IsSum_${r.val}" value="${it}">
                    </label>
                    <label class="control-label text-blue ${a!=0?"":"hidden"}">比较
                        <input type="checkbox" class="icb_minimal dOther cbc IsCompare_${r.val}" value="${g}">
                    </label>
                    <div class=${a!=0?"":"hidden"}${g==1?"":" hidden"}>
                        </br>
                        <label class="control-label">类型</label>
                        <select class="form-control dOther cTimeRangeType_${r.val}" value=${v}>${timeUnderOptions(a)}</select>
                        <div class="input-group${v==0?"":" hidden"}">
                            <input class="form-control text-center dOther cTimeRangeType_0_${r.val}" style="width: 70px;" value=${v==0?"":" hidden"} oninput="onInput(this, 3, 0, 0, 24);">
                            <div class="input-group-addon">${timeTypes[a]}</div>
                        </div>
                        <div class="input-group${v==1?"":" hidden"}">
                            <select class="form-control ms2m dOther cTimeRangeType_1_${r.val}" value="${nt}">${ft}</select>
                        </div>
                        <div class="input-group${v==2?"":" hidden"}">
                            <input class="form-control text-center dOther cTimeRangeType_2_1_${r.val}" style="width: 70px;" value=${v==0?"":" hidden"} oninput="onInput(this, 3, 0, 0, 24);">
                            <label class="control-label">-</label>
                            <input class="form-control text-center dOther cTimeRangeType_2_2_${r.val}" style="width: 70px;" value=${v==0?"":" hidden"} oninput="onInput(this, 3, 0, 0, 24);">
                        </div>
                    </div >`}else d=b.length?s.Shifts:0;const at=y.reduce((n,t,i)=>{const u=lt.filter(n=>n.Field==t.Field),o=u.length?u[0].Column:"",s=u.length?u[0].Axis:0,f=u.length?u[0].DataType:"",p=!!FieldFunc[f],w=u.length?u[0].Special:"",b=p&&!!FieldFunc[f][w],e=t.Column?t.Column:"",h=t.Color?t.Color:"",c=t.Width?t.Width:"",a=t.Pre?t.Pre:"",v=t.Suffix?t.Suffix:"",y=t.Func?t.Func:"";return n+`<tr role="row" style="background-color: #f9f9f9;" value=${t.XvHao}>
                        ...
                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline Or_${i}" value=${t.Order}>
                            <span class="glyphicon glyphicon-arrow-up pointer text-green${i==0?" hidden":""} ${ot&&t.Order?"":" hidden"} sUpTr" aria-hidden="true" title="上移"></span>
                            <span class="glyphicon glyphicon-arrow-down pointer text-red${i+1==et?" hidden":""} ${ot&&t.Order?"":" hidden"}   sDownTr" aria-hidden="true" title="下移"></span>
                        </td>`}
                    </tr>`},"");let ct="";return ct=~its.indexOf(l.Item)?workshopTmp[workshopId].ShiftNameList.reduce((n,t,i)=>`${n}<option value="${i+1}">${t}</option>`,'<option value="0">全天<\/option>'):setOptions(shifts,"Type"),`${n}<div class="kb_div1" style="height: ${r.height==-1?"auto":`${r.height}%`}" col="${r.col}" order="${r.order}" value="${r.val}" display="${l.Display}" >
                            ...
                            <table class="table table-striped no-margin">
                                ...
                                <tbody>
                                    <tr role="row" class="odd">
                                        ...
                                        ${!w[0].BShifts&&!w[0].BDuration?"":`<tr role="row" style="background-color: #f9f9f9;">
                                        <td style="padding: 4px; border: 1px solid gray;" class="form-inline" colspan="${f}" >
                                            <div class="form-group form-inline">
                                            ${w[0].BShifts?`<label class="control-label">班制</label>
                                                <select class="form-control colSet Shift_${r.val}" value=${d}>${ct}</select>`:""}
                                            ${w[0].BDuration?~its.indexOf(l.Item)?`<label class="control-label">时间类型</label>
                                                <select class="form-control colSet Time_${r.val}" value=${a}>${timeOptions}</select>
                                                <label class="control-label">时间范围</label>
                                                <div class="input-group">
                                                    <input class="form-control text-center colSet Range_${r.val}" style="width: 70px;" value=${tt} oninput="onInput(this, 3, 0, 0, 24);">
                                                    <div class="input-group-addon">${timeTypes[a]}</div>
                                                </div>
                                                ${k}`:`<label class="control-label">显示最近</label>
                                                <input class="form-control text-center colSet Hour_${r.val}" style="width: 70px;" value=${b.length?s.Hour:24} oninput="onInput(this, 3, 0, 0, 24);">
                                                <label class="control-label">小时</label>
                                                <input class="form-control text-center colSet Min_${r.val}" style="width: 70px;" value=${b.length?s.Min:0} oninput="onTimeLimitInput(this);">
...
${yt}`,o.MinUseRate,"#f39c12");$(`${u}_minTs`).text(`${o.MinSimultaneousUseRate}台`);$(`${u}_minTNum`).text(yt);$(`${u}_minSyl`).text(oi);var a=o.AllDevice,si=o.NormalDevice,hi=o.ProcessDevice,ci=o.IdleDevice,li=o.FaultDevice,ai=o.ConnectErrorDevice;for(setPieChart(`${u}_state_all`,`${a}台`,a/a,"green","总设备"),setPieChart(`${u}_state_normal`,`${si}台`,si/a,"blue","正常运行"),setPieChart(`${u}_state_process`,`${hi}台`,hi/a,"#0099ff","加工中"),setPieChart(`${u}_state_idle`,`${ci}台`,ci/a,"#cc33ff","闲置中"),setPieChart(`${u}_state_fault`,`${li}台`,li/a,"red","故障中"),setPieChart(`${u}_state_error`,`${ai}台`,ai/a,"#ff00cc","连接异常"),pt=o.UseCodeList||[],d="",h=0,et=pt.length;h<et;h++)d+=`<div style="border:1px solid;padding:5px 10px;margin:3px;border-radius:20%;background:#bfa;font-weight:bold">${pt[h]}</div>`;$(`${u}_dev`).empty().append(d||'<label style="color:red;font-size:18px">无<\/label>');var vi=o.SingleProcessRate,p=[],yi=[];for(h=0,et=vi.length;h<et;h++)wt=vi[h],p.push(wt.Code),yi.push((wt.Rate*100).toFixed(2));w={tooltip:{trigger:"axis",formatter:"{a}<br/>{b} : {c}%",axisPointer:{type:"shadow"}},grid:{left:"3%",right:"3%",top:"6%",bottom:"8%",containLabel:!0},xAxis:{type:"category",axisLine:{onZero:!1},data:p},yAxis:{name:"百分比",type:"value",scale:!0,axisLabel:{show:!0,formatter:"{value}%"}},series:{name:"利用率",type:"bar",areaStyle:{normal:{}},barWidth:"60%",label:{show:!0,position:"top",formatter:"{c}%"},itemStyle:{color:n=>n.value<30?"red":"green"},data:yi},dataZoom:[{type:"inside"},{handleIcon:_handleIcon,handleSize:"80%",handleStyle:{color:"#fff",shadowBlur:3,shadowColor:"rgba(0, 0, 0, 0.6)",shadowOffsetX:2,shadowOffsetY:2}}]};echarts.init($(`${u}_bar`)[0]).setOption(w,!0);$(u).off("resize").on("resize",function(){clearTimeout(this.time);this.time=setTimeout(()=>{for(var t=$(this).find(".chart"),n=0,i=t.length;n<i;n++)echarts.init(t[n]).resize()},200)});v=o.ProductionList;const n=v.reduce((n,t)=>`${n}<td class="text-blue">${t.Code}</td>`,""),t=v.reduce((n,t)=>`${n}<td>${t.DayTotal}</td>`,""),i=v.reduce((n,t)=>`${n}<td>${t.DayQualified}</td>`,""),r=v.reduce((n,t)=>`${n}<td>${t.DayUnqualified}</td>`,""),f=v.reduce((n,t)=>`${n}<td>${t.DayQualifiedRate}%</td>`,""),s=v?v.filter(n=>n.DayTotal>0).length:0;$(`${u}_devs`).text(s);$(`${u}_pros`).text(o.DayTotal);$(`${u}_heGes`).text(o.DayQualified);$(`${u}_liePians`).text(o.DayUnqualified);$(`${u}_rates`).text(`${o.DayQualifiedRate}%`);$(`${u}_devOps`).find("td:not(:first)").remove().end().append(n);$(`${u}_proOps`).find("td:not(:first)").remove().end().append(t);$(`${u}_heGeOps`).find("td:not(:first)").remove().end().append(i);$(`${u}_liePianOps`).find("td:not(:first)").remove().end().append(r);$(`${u}_rateOps`).find("td:not(:first)").remove().end().append(f)}else if(i==2){if(c=`${u}_deviceState`,e.errno!=0){dsDivs[t].forEach(n=>{$(`#${n}`).addClass("hi")});$(`${c} .hi`).css("display","none").removeClass("hi");return}pi=`<div id="{0}" class="kb_device_div1 ds" style="display:none;">
                    ...
                    <div style="top: 2%; height: 65%; position: relative;" id="{0}_detail"></div>
                            ...
                            </table>`}}return e}var a,v,f,o;if(n)for(l=n.length,h=0;h<l;h++)a=n[h],dsPaths[t][a.name]||(dsPaths[t][a.name]=a.path);const tt=Object.keys(dsPaths[t]).length;if(!(tt<=0)){for(v=[],s.forEach(n=>v[n.Id]=1),h=0;h<i;h++){const n=`${u}_ds${h}`;if(f=s[h],f){o="red";switch(f.DeviceStateStr){case"加工中":o="#00A65C";break;case"准备中":o="#ffd400";break;case"待机":case"流程升级中":case"固件升级中":case"设备重启中":case"连接正常":o="#f47920";break;case"已报修":case"已确认":case"维修中":o="red";break;default:o="gray"}const i=it(f.Data,e.cCol,e.cName);$(`${n}_img`).attr("src",dsPaths[t][f.Icon]);$(`${n}_code`).text(f.Code);$(`${n}_mc`).text(`${f.CategoryName}-${f.ModelName}`);$(`${n}_ws`).text(f.SiteName);$(`${n}_state`).css("background",o);$(`${n}_detail`).html(i);$(`${n}`).addClass("sh")}else $(`${n}`).addClass("hi")}$(`${c} .sh`).css("display","block").removeClass("sh");$(`${c} .hi`).css("display","none").removeClass("hi");$(`${u}_jg`).text(e.jg);$(`${u}_zb`).text(e.zb);$(`${u}_xz`).text(e.xz);$(`${u}_zc`).text(e.zc);$(`${u}_gz`).text(e.gz);$(`${u}_wlj`).text(e.wlj);$(`${u}_sum`).text(e.sum);var y=$(".ds"),p=y.length>0?($(y[0]).css("margin").replace("px","")>>0)*2:5,rt=($(c).css("padding").replace("px","")>>0)*2;if(e.row>0){var w=$(c).width(),b=Math.floor(w/(def+p)),ut=e.col>b?b:e.col,k=Math.floor(w/ut)-p,ft=$(window).height();$(`${u}`).css("height",`${ft}px`);var d=$(c).closest(".dsDiv").height(),g=Math.floor(d/def),et=e.row>g?g:e.row,nt=Math.floor(d/et)-rt;$(".ds").css("flex-basis",`${k<def?def:k}px`).css("height",`${nt<def?def:nt}px`)}r&&(page[t]=++e.cp)}};const a=[];for(h=0;h<l;h++)ot=s[h],dsPaths[t][ot.Icon]||~a.lastIndexOf(ot.Icon)||a.push(ot.Icon);if(a.length>0){f={type:fileEnum.Device,files:JSON.stringify(a)};f.dir="";for(kt in fileEnum)if(fileEnum[kt]==f.type){f.dir=kt;break}if(isStrEmptyOrUndefined(f.dir))return void layer.msg("文件类型不存在！");getFilePath(f,bt,0)}else bt()}else if(i==3){if(e.errno!=0)return;if(!e.data)return;var o=e.data,ur=e.colSet?JSON.parse(e.colSet):[],fr=`${u}_productDiv`,rt=$(window).height(),er=$(`${u} .kb_title1`).closest("div").height()>>0;for($(`${fr}`).css("height",`${rt-er}px`),st=0,ki=e.items.length;st<ki;st++){const t=e.items[st],a=t.Item,r=kanBanItems[i][a],h=ur[t.Col].chose[t.Order];if(t&&r&&h){const v=r.FieldList?r.FieldList:[],c=[];v.forEach(n=>{c[n.Field]=n});const d=t.FieldList?t.FieldList:[],f=d.filter(n=>n.Order).sort(firstBy("Order"));if(f&&f.length){const e=`${t.Item}_${t.Col}_${t.Order}`,i=`${u}_${t.Col}_${t.Order}`,tt=$(`${i}`).closest(".kb_border2").height(),rt=$(`${i}`).closest(".kb_border2").find("h4").height(),it=tt-rt;if($(`${i}`).closest(".table-responsive").css("height",`${Math.floor(it*100/tt)}%`),$(`${i}`).closest(".kb_border2").find(".tt1").text(h.name),!o.hasOwnProperty(e))continue;if(s=o[e],r.Display==0){const e=h.dOrder=="0"?"asc":"desc";s=s.sort(firstBy(h.dField,e));$(`${i}`).closest(".kb_border2").find(".tt2").text(`(${s.length})`);addOrderData(s);let u=$(`${i} tbody tr`);if(u.length){const n=$(`${i} tr[class='max']`),h=$(n).attr("order")>>0;let o=!1;if(u.each((n,t)=>{const i=$(t).attr(trFlag),r=s.filter(n=>n[trFlag]==i);r.length||($(t).remove(),o=!0)}),o&&u.length>0&&(u=$(`${i} tbody tr`),g=[],u.each((n,t)=>{var i=$(t).attr(trFlag)>>0;g[i]=t}),l=Object.values(g),l.forEach((n,t)=>{$(n).attr("order",t+1);$(n).attr(trFlag,t+1);var i="";(e=="asc"&&s.length==t+1||e=="desc"&&t==0)&&(i=`max`,$(n).addClass(i))}),u=$(`${i} tbody tr`)),!o){const i=s.length-u.length;if(s.length>u.length){n.removeClass("max");let f=[];f=e=="asc"?sliceArray(s,i,u.length):sliceArray(s,i,0);const o=getItemTrs(f,r,t,e);e=="asc"?n.after(o):n.before(o)}let o=[];o=e=="asc"?sliceArray(s,u.length,0):sliceArray(s,s.length,i);g=[];u.each((n,t)=>{var i=$(t).attr(trFlag)>>0;g[i]=t});l=Object.values(g);l.length&&l.forEach((n,t)=>{var i,a,h;const l=o[t],r=$(n),v=f.filter(n=>n.Field=="XvHao");for(v.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),i=0,a=f.length;i<a;i++){const n=f[i];var s=l[n.Field],y=n.Pre?n.Pre:"",p=n.Suffix?n.Suffix:"",w=n.Width&&n.Width!=="auto"?`width: ${n.Width}px;`:`width: auto;`,e="",u="";if(c[n.Field]&&n.Func){const t=JSON.parse(n.Func);if(t.color==1?u=n.Color:t.color==2&&t.cons.every(n=>meetCondition(s,n.con,n.conv)?(u=n.color,!1):!0),t.special){const i=c[n.Field].DataType;s=FieldFunc[i][t.special].func(s)}t.bold&&(e="text-bold")}u=u?`color: ${u};`:`color: "";`;const o=`${y}${s}${p}`,t=l.XvHao,a=$(r.find("td")[i]).text(),v=$(r).attr("order")>>0;a!=o&&$(r.find("td")[i]).html(o);v!=t&&($(r).attr("XvHao",t),$(r).attr("order",t));h=$(r.find("td")[i]).hasClass("text-bold");e&&!h?$(r.find("td")[i]).addClass(e):!e&&h&&$(r.find("td")[i]).removeClass(e);$(r.find("td")[i]).attr("style",w);$(r.find("td")[i]).attr("style",u)}})}}else s.length&&$(`${i} tbody`).html(getItemTrs(s,r,t,e));di=$(`${i} tr`).height();gi=it-$(`${i} tbody`).closest(".kb_item_tablebox").css("padding").replace("px","")*2;u=$(`${i} tbody tr`);dt=Math.floor(gi/di)-1;const o=`${n}_${t.Col}_${t.Order}_timer`;u.length>dt&&!kanBanProductItemsEl[o]?scrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`):u.length<=dt&&(nr=getItemTrs(s,r,t,e),$(`${i} tbody`).html(nr),kanBanProductItemsEl[o]&&stopScrollTable(kanBanProductItemsEl,o,`${n}_${t.Col}_${t.Order}`))}else if(r.Display==1){if(!s.length)continue;if(!f.length)continue;ut=f[0];b="";switch(r.DisplayType){case 0:b="line";break;case 1:b="bar";break;case 2:b="pie"}if(isStrEmptyOrUndefined(b))continue;if(gt=v.filter(n=>n.Axis==0),!gt.length)continue;ht=gt[0];ct=ht.Field;const n=h.dOrder=="0"?"asc":"desc";if(s=s.sort(firstBy(h.dField,n)),ni=d.filter(n=>n.Field==ct),!ni.length)continue;var tr=ni[0],ti=null,ir=null,ii=null;if(~its.indexOf(a)&&tr.Func){const n=JSON.parse(tr.Func);n.special&&(ti=FieldFunc[ht.DataType][n.special].func,ir=1,t.ConfigList&&(lt=0,t.ConfigList.length>lt&&(timeType=t.ConfigList[lt].length>1?t.ConfigList[lt][1]:timeType,ii=timeTypes[timeType])))}var p=distinct(s.map(n=>ti?ti(n[ct],ir):n[ct])),k=[],nt="";switch(r.Item){case 9:nt="Production";break;case 10:nt="Code";break;case 11:nt="Processor"}if(isStrEmptyOrUndefined(nt))continue;y=distinct(s.map(n=>n[nt]).filter(n=>n));y.length?y.forEach(n=>{var t=s.filter(t=>t[nt]==n).map(n=>n[ut.Field]);k.push({name:n,type:b,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:t})}):(rr=s.map(n=>n[ut.Field]),k.push({type:b,label:{show:!0,position:"top",fontWeight:"bold",fontSize:14},lineStyle:{width:3},data:rr}));pTableOrChart[i]?(w={},ft=!1,isEqual(pTableOrChart[i].lData,y)||(ft=!0,w.legend=y),isEqual(pTableOrChart[i].xData,p)||(ft=!0,w.xAxis={data:p}),isEqual(pTableOrChart[i].series,k)||(ft=!0,w.series=k),ft&&(pTableOrChart[i].chart.setOption(w),pTableOrChart[i].lData=y,pTableOrChart[i].xData=p,pTableOrChart[i].series=k)):(pTableOrChart[i]={lData:y,xData:p,series:k,chart:echarts.init($(i)[0])},pTableOrChart[i].chart.setOption({tooltip:{trigger:"axis"},grid:{left:"3%",right:"6%",bottom:"3%",containLabel:!0},color:["#00a65a","red","#ff00ff","#cc3300","#ff9900","#9933ff","blue","#0099ff","#660066"],xAxis:{name:ii?ii:ht.Field,nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"category",boundaryGap:!1,data:p,axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:19}}},yAxis:{name:ut?ut.Column:"",nameTextStyle:{color:"white",fontWeight:"bold",fontSize:14},type:"value",axisLine:{lineStyle:{color:"white",fontWeight:"bold",fontSize:16}}},legend:{data:y,textStyle:{color:"white",fontWeight:"bold",fontSize:16}},series:k},!0),$(i).resize(function(){for(var n in pTableOrChart){const t=pTableOrChart[n];t.chart&&t.chart.resize()}}))}}}}}},0)}}function getItemTrs(n,t,i,r){const u=[];t.FieldList&&t.FieldList.forEach(n=>{u[n.Field]=n});const f=i.FieldList?i.FieldList.filter(n=>n.Order):[],e=f.filter(n=>n.Field=="XvHao");return e.length||f.unshift({Order:0,Column:"序号",Field:"XvHao",Width:"60"}),n.reduce((t,i,e)=>{const s=f.reduce((n,t,r)=>{var e=i[t.Field],h=t.Pre?t.Pre:"",c=t.Suffix?t.Suffix:"",l=t.Width&&t.Width!=="auto"?`width: ${t.Width}px;`:`width: auto;`,o="",f="",r,s;if(u[t.Field]&&t.Func){const n=JSON.parse(t.Func);if(n.color==1)f=t.Color;else if(n.color==2)for(r=0,s=n.cons.length;r<s;r++){const t=n.cons[r];if(meetCondition(e,t.con,t.conv)){f=t.color;break}}if(n.special){const i=u[t.Field].DataType;e=FieldFunc[i][n.special].func(e)}n.bold&&(o="text-bold")}return f=f?`color: ${f};`:``,n+`<td class="${o}" style='${l}${f}'>${h}${e}${c}</td>`},"");var o="";return(r=="asc"&&n.length==e+1||r=="desc"&&e==0)&&(o=` class="max"`),t+`<tr${o} order=${i.XvHao} ${trFlag}=${i[trFlag]}>${s}</tr>`},"")}function setPieChart(n,t,i,r,u){i=i||0;var e=`${(i*100).toFixed(2)}%`,f={color:["#cdcdcd",r],series:{type:"pie",center:["50%","50%"],radius:["65%","100%"],hoverAnimation:!1,animation:!1,silent:!0,label:{show:!0,position:"center",formatter:`${t}
