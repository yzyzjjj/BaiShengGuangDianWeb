function pageReady(){$(".ms2").select2();getTaskConfig();$("#configItem").on("ifChanged",".isEnable",function(){var n=$(this).parents("tr"),i=$(this).val(),t=_taskItem[i],r,u;$(this).is(":checked")?(n.find(".textIn").removeClass("hidden").siblings(".textOn").addClass("hidden"),r=t.GroupId,n.find(".group").val(r).trigger("change"),u=n.find(".processor"),setProcessorSelect(r,u),u.val(t.Person).trigger("change"),n.find(".module").val(t.ModuleId).trigger("change"),t.IsCheck?(n.find(".taskName").addClass("hidden").siblings().removeClass("hidden"),n.find(".taskNameSelect").val(t.CheckId).trigger("change")):n.find(".taskNameSelect").parent().addClass("hidden").siblings().removeClass("hidden"),n.find(".taskName").val(t.Item),n.find(".hour").val(t.EstimatedHour),n.find(".minute").val(t.EstimatedMin),n.find(".score").val(t.Score),n.find(".desc").val(t.Desc),n.find(".relation").val(n.find(".relationText").text()),_taskItemId.push(i)):(n.find(".textOn").removeClass("hidden").siblings(".textIn").addClass("hidden"),_taskItemId.splice(_taskItemId.indexOf(i),1))});$("#configItem").on("select2:select",".group",function(){var n=$(this).val(),t=$(this).parents("tr").find(".processor");setProcessorSelect(n,t)});$("#configItem").on("select2:select",".module",function(){var t=$(this).val(),i=$(this).find(`option[value=${t}]`).attr("isCheck"),n=$(this).parents("tr");parseInt(i)?n.find(".taskName").addClass("hidden").siblings().removeClass("hidden"):n.find(".taskNameSelect").parent().addClass("hidden").siblings().removeClass("hidden")});$("#selectConfig").on("select2:select",function(){getTaskConfigItem()});$("#configItem").on("input",".minute",function(){var n=$(this).val();parseInt(n)>59&&$(this).val(59)});$("#configItem").on("focus",".toZero",function(){var n=$(this).val();n==0&&$(this).val("")});$("#configItem").on("blur",".toZero",function(){var n=$(this).val();isStrEmptyOrUndefined(n)&&$(this).val("0")});$("#configItem").on("click",".moveUp",function(){var n,f,i,h,l;_isUpMove=!1;var t=$(this).parents("tr"),s=t.find(".relation"),a=s.is(":hidden"),u=a?t.find(".relationText").text():s.val();if(u=parseInt(u),n=t.find(".num").text(),n=parseInt(n),u+1==n){layer.msg("不能上移到关联任务前");return}for(f=t.nextAll(),i=0,h=f.length;i<h;i++){var c=f.eq(i),e=c.find(".relationText"),o=c.find(".relation"),r=n-1;switch(parseInt(e.text())){case n:e.text(r);break;case r:e.text(n)}switch(parseInt(o.val())){case n:o.val(r);break;case r:o.val(n)}}l=t.prev();l.before(t);setTableStyle()});$("#configItem").on("input",".relation",function(){var t=$(this).val(),i,n;t=parseInt(t);i=$(this).parents("tr");n=i.find(".num").text();n=parseInt(n)-1;t>n&&$(this).val(n)});$("#configSelect").on("select2:select",function(){$("#newConfig").val($(this).find("option:checked").text())});$("#configReuse").on("ifChanged",function(){$(this).is(":checked")?$("#updateConfigBtn").attr("disabled","disabled"):$("#updateConfigBtn").removeAttr("disabled")});$("#moduleSelect").on("select2:select",function(){$("#newModule").val($(this).find("option:checked").text())});$(".maxHeight").css("maxHeight",innerHeight*.7)}function setProcessorSelect(n,t){var f,u,i,e,r;for(t.empty(),f='<option value = "{0}">{1}<\/option>',u="",i=0,e=_processor.length;i<e;i++)r=_processor[i],n==r.GroupId&&(u+=f.format(r.ProcessorId,r.Processor));t.append(u)}function getTaskConfig(){var t=1051,n;if(!checkPermission(t)){layer.msg("没有权限");return}n={};n.opType=t;ajaxPost("/Relay/Post",n,function(n){var t,f,i;if(n.errno!=0){layer.msg(n.errmsg);return}var r=n.datas,u="";for(_taskConfigName=[],t=0,f=r.length;t<f;t++)i=r[t],_taskConfigName.push(i.Task),u+='<option value = "{0}">{1}<\/option>'.format(i.Id,i.Task);$(".selectConfig").empty();$(".selectConfig").append(u);$("#configSelect").val(0).trigger("change");taskTrData()})}function getGroup(n){var i=1077,t;if(!checkPermission(i)){layer.msg("没有权限");return}t={};t.opType=i;t.opData=JSON.stringify({menu:!0});ajaxPost("/Relay/Post",t,function(t){var i,e,r;if(t.errno!=0){layer.msg(t.errmsg);return}var u=t.datas,f="";for(i=0,e=u.length;i<e;i++)r=u[i],f+='<option value = "{0}">{1}<\/option>'.format(r.Id,r.Group);n!=null&&n(f)})}function getProcessor(n){var i=1081,t;if(!checkPermission(i)){layer.msg("没有权限");return}t={};t.opType=i;t.opData=JSON.stringify({groupId:0,menu:!0});ajaxPost("/Relay/Post",t,function(t){var f,r,i,e,u;if(t.errno!=0){layer.msg(t.errmsg);return}for(_processor=t.datas,f='<option value = "{0}">{1}<\/option>',r="",i=0,e=_processor.length;i<e;i++)u=_processor[i],r+=f.format(u.ProcessorId,u.Processor);n!=null&&n(r)})}function getModule(n){var i=1058,t;if(!checkPermission(i)){layer.msg("没有权限");return}t={};t.opType=i;t.opData=JSON.stringify({menu:!0});ajaxPost("/Relay/Post",t,function(t){var r,e,i;if(t.errno!=0){layer.msg(t.errmsg);return}var u=t.datas,f="";for(_moduleName=[],r=0,e=u.length;r<e;r++)i=u[r],_moduleName.push(i.Module),f+='<option value = "{0}" isCheck = "{2}">{1}<\/option>'.format(i.Id,i.Module,i.IsCheck);n!=null&&n(f)})}function getTaskName(n){var i=1066,t;if(!checkPermission(i)){layer.msg("没有权限");return}t={};t.opType=i;t.opData=JSON.stringify({menu:!0});ajaxPost("/Relay/Post",t,function(t){var r,e,u;if(t.errno!=0){layer.msg(t.errmsg);return}var f=t.datas,i="";for(r=0,e=f.length;r<e;r++)u=f[r],i+='<option value = "{0}">{1}<\/option>'.format(u.Id,u.Check);i=`<select class="ms2 form-control taskNameSelect">${i}</select>`;n!=null&&n(i)})}function setTableStyle(){for(var t=$("#configItem tr .num"),n=0,i=t.length;n<i;n++)t.eq(n).text(n+1);$("#configItem").find(".isEnable").iCheck({handle:"checkbox",checkboxClass:"icheckbox_minimal-blue",increaseArea:"20%"});$("#configItem").find(".ms2").select2();$("#configItem .moveUp").removeClass("hidden");$("#configItem .moveUp").eq(0).addClass("hidden")}function taskTrData(){var n=new Promise(function(n){getGroup(n)}),t=new Promise(function(n){getProcessor(n)}),i=new Promise(function(n){getModule(n)}),r=new Promise(function(n){getTaskName(n)});Promise.all([n,t,i,r]).then(function(n){_taskTrData=`<tr>
            ...
            <td><div style="width: 120px;margin:auto"><input type="text" class="form-control text-center taskName" maxlength="10"><div class="hidden">${n[3]}</div></div></td>
            <td>
