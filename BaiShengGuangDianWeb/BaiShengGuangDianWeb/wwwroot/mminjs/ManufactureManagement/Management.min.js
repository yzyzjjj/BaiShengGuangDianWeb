function pageReady(){$(".ms2").select2();$(".table-bordered td").css("border","1px solid");var n=getDayAgo(1),t=getDate();$("#spTime,#startTime").val(n).datepicker("update");$("#epTime,#endTime").val(t).datepicker("update");window.onload=()=>{$("#spTime,#epTime,#startTime,#endTime").removeAttr("readonly")};getPlan();getGroup();getState();$("#groupSelect").on("select2:select",function(){getProcessor()});$("#updateTask").on("click",function(){if(_isClick=!_isClick,_isClick){$("#taskEstimatedTime .textOn").addClass("hidden").siblings(".textIn").removeClass("hidden");$("#taskScore .textOn").addClass("hidden").siblings(".textIn").removeClass("hidden");$("#taskEstimatedTime .hour").val(_taskDetailData.EstimatedHour);$("#taskEstimatedTime .minute").val(_taskDetailData.EstimatedMin);$("#taskScore .score").val(_taskDetailData.Score);var n=$(this).val();n==3&&($("#taskActualTime .textOn").addClass("hidden").siblings(".textIn").removeClass("hidden"),$("#taskActualScore .textOn").addClass("hidden").siblings(".textIn").removeClass("hidden"),$("#taskActualTime .hour").val(_taskDetailData.ActualHour),$("#taskActualTime .minute").val(_taskDetailData.ActualMin),$("#taskActualScore .score").val(_taskDetailData.ActualScore))}else $("#taskDesc").val(_taskDetailData.Desc),$("#taskDetailTable .textOn").removeClass("hidden").siblings(".textIn").addClass("hidden");$("#taskDesc").prop("disabled",!_isClick)});$("#updateCheck").on("click",function(){if(_isClick=!_isClick,_isClick){$("#checkDetailTable .textOn").addClass("hidden").siblings(".textIn").removeClass("hidden");$("#checkEstimatedTime .hour").val(_taskDetailData.EstimatedHour);$("#checkEstimatedTime .minute").val(_taskDetailData.EstimatedMin);$("#checkScore .score").val(_taskDetailData.Score);var n=$(this).val();n==3?($("#checkActualTime .hour").val(_taskDetailData.ActualHour),$("#checkActualTime .minute").val(_taskDetailData.ActualMin),$("#checkActualScore .score").val(_taskDetailData.ActualScore),$("#checkResult").val(_taskDetailData.CheckResult)):($("#checkActualTime .textOn").removeClass("hidden").siblings(".textIn").addClass("hidden"),$("#checkActualScore .textOn").removeClass("hidden").siblings(".textIn").addClass("hidden"),$("#checkResultDesc .textOn").removeClass("hidden").siblings(".textIn").addClass("hidden"))}else $("#checkDesc").val(_taskDetailData.Desc),$("#checkDetailTable .textOn").removeClass("hidden").siblings(".textIn").addClass("hidden");$("#checkDesc").prop("disabled",!_isClick)});$(".minute").on("input",function(){var n=$(this).val();parseInt(n)>59&&$(this).val(59)});$(".toZero").on("focus",function(){var n=$(this).val();n==0&&$(this).val("")});$(".toZero").on("blur",function(){var n=$(this).val();isStrEmptyOrUndefined(n)&&$(this).val("0")});$("#taskList").on("click",".delAddTask",function(){var n=$(this).parents("tr");setNumTotalOrder(n,-1);$("#taskList .addTask").prop("disabled",!1);n.remove()});$("#taskList").on("input",".minute",function(){var n=$(this).val();parseInt(n)>59&&$(this).val(59)});$("#taskList").on("focus",".toZero",function(){var n=$(this).val();n==0&&$(this).val("")});$("#taskList").on("blur",".toZero",function(){var n=$(this).val();isStrEmptyOrUndefined(n)&&$(this).val("0")});$("#taskList").on("select2:select",".group",function(){var n=$(this).val(),t=$(this).parents("tr").find(".processor");setProcessorSelect(n,t)});$("#taskList").on("select2:select",".module",function(){var t=$(this).find("option:selected").attr("isCheck"),n=$(this).parents("tr");parseInt(t)?n.find(".taskName").addClass("hidden").siblings().removeClass("hidden"):n.find(".taskNameSelect").parent().addClass("hidden").siblings().removeClass("hidden")});$("#taskList").on("input",".relation",function(){var t=$(this).val(),i,n;t=parseInt(t);i=$(this).parents("tr");n=i.find(".order").text();n=parseInt(n)-1;t>n&&$(this).val(n)});$("#stateAll").on("ifChanged",function(){$(this).is(":checked")?$("#stateCheck .icb_minimal").iCheck("check"):_stateCheck.length==$("#stateCheck").children().length&&$("#stateCheck .icb_minimal").iCheck("uncheck")});$("#stateCheck").on("ifChanged",".icb_minimal",function(){var n=$(this).val();$(this).is(":checked")?(_stateCheck.push(n),_stateCheck.length==$("#stateCheck").children().length&&$("#stateAll").iCheck("check")):(_stateCheck.splice(_stateCheck.indexOf(n),1),_stateCheck.length==$("#stateCheck").children().length-1&&$("#stateAll").iCheck("uncheck"))});$("#processorAll").on("ifChanged",function(){$(this).is(":checked")?$("#processorCheck .icb_minimal").iCheck("check"):_processorCheck.length==$("#processorCheck").children().length&&$("#processorCheck .icb_minimal").iCheck("uncheck")});$("#processorCheck").on("ifChanged",".icb_minimal",function(){var n=$(this).val();$(this).is(":checked")?(_processorCheck.push(n),_processorCheck.length==$("#processorCheck").children().length&&$("#processorAll").iCheck("check")):(_processorCheck.splice(_processorCheck.indexOf(n),1),_processorCheck.length==$("#processorCheck").children().length-1&&$("#processorAll").iCheck("uncheck"))});$("#taskTable").css("maxHeight",innerHeight*.7)}function foldList(){$("#navBox").toggleClass("hidden");$(this).toggleClass("glyphicon-triangle-left glyphicon-triangle-right").prop("title",$("#navBox").is(":hidden")?"展开":"收起")}function setCheckStyle(n){$(`${n} .icb_minimal`).iCheck({handle:"checkbox",checkboxClass:"icheckbox_minimal-green",increaseArea:"20%"})}function setProcessorSelect(n,t){var f,u,i,e,r;for(t.empty(),f='<option value = "{0}">{1}<\/option>',u="",i=0,e=_processor.length;i<e;i++)r=_processor[i],n==r.GroupId&&(u+=f.format(r.ProcessorId,r.Processor));t.append(u)}function getPlan(){var t=1025,n;if(!checkPermission(t)){layer.msg("没有权限");return}n={};n.opType=t;ajaxPost("/Relay/Post",n,function(n){var t,f,i;if(n.errno!=0){layer.msg(n.errmsg);return}$("#planSelect").empty();var r=n.datas,u='<option value="0" task=0>所有计划<\/option>';for(t=0,f=r.length;t<f;t++)i=r[t],u+='<option value="{0}" task="{2}">{1}<\/option>'.format(i.Id,i.Plan,i.TaskId);$("#planSelect").append(u)})}function getGroup(n){var i=1077,t;if(!checkPermission(i)){layer.msg("没有权限");return}t={};t.opType=i;t.opData=JSON.stringify({menu:!0});ajaxPost("/Relay/Post",t,function(t){var i,e,u;if(t.errno!=0){layer.msg(t.errmsg);return}var f=t.datas,r="";for(i=0,e=f.length;i<e;i++)u=f[i],r+='<option value="{0}">{1}<\/option>'.format(u.Id,u.Group);n==null?($("#groupSelect").empty().append(`<option value="0">所有分组</option>${r}`),getProcessor()):n(r)})}function getProcessor(n){var r=1081,i,t;if(!checkPermission(r)){layer.msg("没有权限");return}(i=n==null?$("#groupSelect").val():0,i!=null)&&(t={},t.opType=r,t.opData=JSON.stringify({groupId:i,menu:!0}),ajaxPost("/Relay/Post",t,function(t){var u,e,i,r,f;if(t.errno!=0){layer.msg(t.errmsg);return}if(_processor=t.datas,u=_processor.length,u){for(e=n==null?'<label class="flexStyle pointer"><input type="checkbox" class="icb_minimal" value="{0}"><span class="textOverTop" style="margin-left: 5px">{1}<\/span><\/label>':'<option value="{0}">{1}<\/option>',i="",r=0;r<u;r++)f=_processor[r],i+=e.format(f.Id,f.Processor);n==null?($("#processorCheck").empty().append(i),setCheckStyle("#processorCheck")):n(i)}},0))}function getState(){var t=1024,n;if(!checkPermission(t)){layer.msg("没有权限");return}n={};n.opType=t;ajaxPost("/Relay/Post",n,function(n){var i,r,t,f,u;if(n.errno!=0){layer.msg(n.errmsg);return}for($("#stateCheck").empty(),i=n.datas,r="",t=0,f=i.length;t<f;t++)u=i[t],r+=`<label class="flexStyle pointer"><input type="checkbox" class="icb_minimal" value=${u.Id}><span class="textOverTop" style="margin-left: 5px">${u.State}</span></label>`;$("#stateCheck").append(r);setCheckStyle("#stateCheck")})}function showLogModel(){var i=1088,t,n;if(!checkPermission(i)){layer.msg("没有权限");return}if(t=$("#planSelect").val(),isStrEmptyOrUndefined(t)){layer.msg("请选择计划号");return}$("#planName").text($("#planSelect option:selected").text());n={};n.opType=i;n.opData=JSON.stringify({planId:t});ajaxPost("/Relay/Post",n,function(n){var r,u,t,o,i;if(n.errno!=0){layer.msg(n.errmsg);return}for($("#planTaskLog").empty(),r=n.datas,u="",t=0,o=r.length;t<o;t++){var f=r[t],s=f.Items.length,e="";if(s)for(i=0;i<s;i++)e+=`<li>${f.Items[i]}</li>`;u+=`<div class="box box-solid noShadow collapsed-box" style="margin-bottom: 0;">
            ...
            <div class="box-body no-padding">
                <ul class="on_ul nav nav-pills nav-stacked mli" style="text-indent: 2em">${e}</ul>
        ...
        </div>`}$("#planTaskLog").append(u);$("#showLogModal").modal("show")})}function getTaskList(){var s=1026,i,n,r,u,f,e,o,t;if(!checkPermission(s)){layer.msg("没有权限");return}if(_taskData={},i=$("#planSelect").val(),isStrEmptyOrUndefined(i)){layer.msg("请选择计划号");return}if(n={planId:i},r=$("#spTime").val(),isStrEmptyOrUndefined(r)||(n.spTime=`${r} 00:00:00`),u=$("#epTime").val(),isStrEmptyOrUndefined(u)||(n.epTime=`${u} 23:59:59`),f=$("#startTime").val(),isStrEmptyOrUndefined(f)||(n.sTime=`${f} 00:00:00`),e=$("#endTime").val(),isStrEmptyOrUndefined(e)||(n.eTime=`${e} 23:59:59`),$("#stateAll").is(":checked")?n.state=-1:_stateCheck.length&&(n.state=_stateCheck.join(",")),o=$("#groupSelect").val(),isStrEmptyOrUndefined(o)){layer.msg("请选择工作组");return}n.gId=o;$("#processorAll").is(":checked")?n.pId=0:_processorCheck.length&&(n.pId=_processorCheck.join(","));t={};t.opType=s;t.opData=JSON.stringify(n);ajaxPost("/Relay/Post",t,function(n){var u,i,e,o,s,h;if(n.errno!=0){layer.msg(n.errmsg);return}if($("#taskList").empty(),u=n.datas,e=u.length,!e){$("#taskTable").addClass("hidden");layer.msg("无数据");return}for(o="",i=0;i<e;i++){var t=u[i],f=t.State,r=t.Id;_taskData[r]=t;s=t.TotalOrder;h=`<tr>
                    <td class="num">${i+1}</td>
                    <td>${t.Processor}</td>
                    <td>${t.Plan}</td>
                    ...
                    <td>${f==0&&i!=0?'<button type="button" class="btn btn-primary btn-sm" onclick="upTask({0},{1},{2},{3})">上移<\/button>'.format(s,u[i-1].TotalOrder,r,u[i-1].Id):""}</td>
                    ...
                    <td>
                        <button type="button" class="btn btn-success btn-sm addTask" onclick="addTask.call(this,${r})"><i class="fa fa-plus"></i></button>
                        <button type="button" class="btn btn-danger btn-sm" onclick="delTask(${r},'${t.Item}')"><i class="fa fa-minus"></i></button>
                        ${f==3?"":f==4?'<button type="button" class="btn btn-primary btn-sm" onclick="taskStartStop(1,{0},\'{1}\')">启动<\/button>'.format(r,t.Item):'<button type="button" class="btn btn-warning btn-sm" onclick="taskStartStop(0,{0},\'{1}\')">停止<\/button>'.format(r,t.Item)}
                    </td>
