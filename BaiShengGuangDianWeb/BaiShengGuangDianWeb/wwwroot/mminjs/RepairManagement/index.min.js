function pageReady(){var n,t;_permissionList[41]={uIds:["showFaultModelBtn"]};_permissionList[34]={uIds:["showMaintainerModel"]};_permissionList[45]={uIds:["showAddMaintainerModelBtn"]};_permissionList[46]={uIds:["updateMaintainerBtn"]};_permissionList[47]={uIds:["delMaintainerBtn"]};_permissionList[35]={uIds:["getFaultTypeList"]};_permissionList[52]={uIds:["showAddFaultTypeModel"]};_permissionList[53]={uIds:[]};_permissionList[54]={uIds:[]};_permissionList[36]={uIds:["getUsuallyFaultList"]};_permissionList[59]={uIds:["showAddUsuallyFaultModel"]};_permissionList[60]={uIds:[]};_permissionList[61]={uIds:[]};_permissionList[37]={uIds:["getFaultDeviceListBtn"]};_permissionList[66]={uIds:[]};_permissionList[67]={uIds:["showBatchAssignModalBtn"]};_permissionList[68]={uIds:[]};_permissionList[69]={uIds:[]};_permissionList[70]={uIds:[]};_permissionList[71]={uIds:["delChangeBtn"]};_permissionList[38]={uIds:["getServiceLogListBtn"]};_permissionList[76]={uIds:["showStatisticsModelBtn"]};_permissionList[77]={uIds:["addServiceLogBtn"]};_permissionList[78]={uIds:["updateServiceLogBtn"]};_permissionList[79]={uIds:["delServiceLogBtn"]};_permissionList[39]={uIds:["getDelFaultDeviceListBtn"]};_permissionList[40]={uIds:["getDelServiceLogListBtn"]};_permissionList=checkPermissionUi(_permissionList);n=$("#tabs li:not(.hidden)").first();n&&(n.addClass("active"),$(n.find("a").attr("href")).addClass("active"));$(".ms2").select2();$("#serLogFaultType").on("change",function(){var n=$(this).val();$("#serLogFaultDesc").val(_faultTypeData[n].FaultDescription)});$("#faultType").on("change",function(){var n=$(this).val();$("#faultDefaultDesc").val(_faultTypeData[n].FaultDescription)});getWorkerSelect();getFaultTypeSelect();t=getMonthScope();$("#faultSTime,#serviceLogSTime,#delFSTime,#delRepairSTime,#statSTime").val(t.start).datepicker("update");$("#faultETime,#serviceLogETime,#delFETime,#delRepairETime,#statETime").val(t.end).datepicker("update");$("#faultDevicePro").on("change",function(){var r=$(this).val(),n="#faultQuery",t="faultDeviceAttr",i="#faultDeviceAttrSelect";switch(r){case"code":setFaultDeviceGet(n,t,"#faultDeviceInput");break;case"faultType":setFaultDeviceGet(n,t,i,_faultType);break;case"priority":setFaultDeviceGet(n,t,i,_priority);break;case"grade":setFaultDeviceGet(n,t,i,_grade);break;case"state":setFaultDeviceGet(n,t,i,'<option value="0">未确认<\/option><option value="1">已确认<\/option><option value="2">维修中<\/option>');break;case"maintainer":setFaultDeviceGet(n,t,i,`<option value="0" wname="0">未指派</option>${_worker}`);break;case"solveTime":$("#solveSTime,#solveETime").removeAttr("readonly");setFaultDeviceGet(n,t,"#faultDeviceTime")}});$("#serviceLogPro").on("change",function(){var r=$(this).val(),n="#serviceLogQuery",t="serviceAttr",i="#serviceAttrSelect";switch(r){case"code":setFaultDeviceGet(n,t,"#serviceInput");break;case"faultType":setFaultDeviceGet(n,t,i,_faultType);break;case"priority":setFaultDeviceGet(n,t,i,_priority);break;case"grade":setFaultDeviceGet(n,t,i,_grade);break;case"maintainer":setFaultDeviceGet(n,t,i,`<option value="0" wname="0">未指派</option>${_worker}`);break;default:$("#serSTime,#serETime").removeAttr("readonly");setFaultDeviceGet(n,t,"#solveTime")}});$("#delFPro").on("change",function(){var r=$(this).val(),n="#delFQuery",t="delFAttr",i="#delFAttrSelect";switch(r){case"code":setFaultDeviceGet(n,t,"#delFInput");break;case"faultType":setFaultDeviceGet(n,t,i,_faultType);break;case"priority":setFaultDeviceGet(n,t,i,_priority);break;case"grade":setFaultDeviceGet(n,t,i,_grade);break;case"state":setFaultDeviceGet(n,t,i,'<option value="0">未确认<\/option><option value="1">已确认<\/option><option value="2">维修中<\/option>');break;case"maintainer":setFaultDeviceGet(n,t,i,`<option value="0" wname="0">未指派</option>${_worker}`);break;case"solveTime":$("#delFSolveSTime,#delFSolveETime").removeAttr("readonly");setFaultDeviceGet(n,t,"#delFTime")}});$("#delRepairPro").on("change",function(){var r=$(this).val(),n="#delRepairQuery",t="delRepairAttr",i="#delRepairAttrSelect";switch(r){case"code":setFaultDeviceGet(n,t,"#delRepairInput");break;case"faultType":setFaultDeviceGet(n,t,i,_faultType);break;case"priority":setFaultDeviceGet(n,t,i,_priority);break;case"grade":setFaultDeviceGet(n,t,i,_grade);break;case"maintainer":setFaultDeviceGet(n,t,i,`<option value="0" wname="0">未指派</option>${_worker}`);break;default:$("#delRepSTime,#delRepETime").removeAttr("readonly");setFaultDeviceGet(n,t,"#delRepairTime")}});getFaultDeviceList();setTimeout(()=>getServiceLogList(0),2e3);$("#batchAssignList").on("change",".serviceName",function(){$(this).val()=="同上"&&$(this).val($(this).parents("tr").prev().find(".serviceName").val());var n=$(this).find("option:selected").attr("phone"),t=$(this).parents("td").next();t.text(n)});$("#serLogDevSite,#devSite").select2({allowClear:!0,placeholder:"请选择(可不选)"});$("#faultCode").select2({allowClear:!0,placeholder:"请选择"});$("#serLogWorkshop").on("change",function(){setWorkSiteSelect("#serLogWorkshop","#serLogDevSite")});$("#workshop").on("change",function(){setWorkSiteSelect("#workshop","#devSite")})}function setFaultDeviceGet(n,t,i,r){$(`${n} .${t}`).addClass("hidden");$(i).removeClass("hidden");r&&($(`#${t}`).empty(),$(`#${t}`).append(`<option value="-1">所有</option>${r}`))}function getWorkerSelect(){var n={};n.opType=430;n.opData=JSON.stringify({menu:!0});ajaxPost("/Relay/Post",n,function(n){var r,u,t,f,i;if(n.errno!=0){layer.msg(n.errmsg);return}for($("#designateName,#servicePro").empty(),r=n.datas,u='<option value="{0}" wname="{1}" phone="{2}">{1}<\/option>',_worker="",t=0,f=r.length;t<f;t++)i=r[t],_worker+=u.format(i.Account,i.Name,i.Phone);$("#designateName,#servicePro").append(_worker)},0)}function getFaultTypeSelect(){var n={};n.opType=406;ajaxPost("/Relay/Post",n,function(n){var r,u,i,f,t;if(n.errno!=0){layer.msg(n.errmsg);return}for($("#serviceFaultType").empty(),r=n.datas,u='<option value="{0}">{1}<\/option>',_faultType="",_faultTypeData={},i=0,f=r.length;i<f;i++)t=r[i],_faultTypeData[t.Id]=t,_faultType+=u.format(t.Id,t.FaultTypeName);$("#serviceFaultType").append(_faultType)},0)}function setTable(){return{isEnable:n=>`<input type="checkbox" class="icb_minimal isEnable" value=${n.Id} fName=${n.DeviceCode}>`,order:(n,t,i,r)=>r.row+1,grade:n=>n?'<span class="text-red">大修<\/span>':"小修",setTime:n=>n=="0001-01-01 00:00:00"?"":n.slice(0,n.lastIndexOf(":")),rState:n=>n.State==0?'<span class="text-red">未确认<\/span>':n.State==1?'<span class="text-warning">已确认<\/span>':'<span class="text-success">维修中<\/span>',priority:n=>n.Priority==0?"低":n.Priority==1?'<span class="text-warning">中<\/span>':'<span class="text-red">高<\/span>',remark:n=>n==""||n.length<tdShowLength?n:`<span title = "${n}" class="pointer" onclick="showAllContent('${escape(n)}', '维修备注')">${n.substring(0,tdShowLength)+"..."}</span>`,rDesc:n=>{var t=n.FaultDescription;return`<span title = "${t}" onclick = "showFaultTypeDetailModel(${n.FaultTypeId}, '${escape(t.trim())}')">${t.length>tdShowLength?t.substring(0,tdShowLength)+"...":t}</span>`},imgBtn:n=>{var t=`<span class="glyphicon glyphicon-{0}" aria-hidden="true" style="color:{1};font-size:25px;vertical-align:middle;margin-right:5px"></span>
        ...
        </tr>`.format(addMax,addMaxV),$("#addList").append(f),t=addMax,n="#addUser"+t,$(n).empty(),users&&users.length>0){for(u="",i=0;i<users.length;i++)r=users[i],u+=`<option value="${r.account}" title="${r.account}">${r.name}</option>`;$(n).append(u);$("#addPhone"+t).val(users[0].phone);$(n).on("select2:select",function(){var r=$(this).val(),i=$(this).parents("tr:first").attr("value"),n,t;for($("#addPhone"+i).val(""),n=0;n<users.length;n++)if(t=users[n],r==t.account){$("#addPhone"+i).val(t.phone);break}})}n="#add"+t;$(n).find(".ms2").css("width","100%");$(n).find(".ms2").select2({width:"120px"});$("#addTable").scrollTop($("#addTable")[0].scrollHeight)}function delOne(n){var i,r,t,u;for($("#addList").find(`tr[value=${n}]:first`).remove(),addMaxV--,i=1,r=$("#addList tr"),t=0;t<r.length;t++)$(r[t]).attr("xh",i),u=$(r[t]).attr("value"),$("#addXh"+u).html(i),i++}function addMaintainer(){for(var i,h,c=432,r=$("#addList tr"),u=[],n=0;n<r.length;n++){var t=$(r[n]).attr("value"),e=$(r[n]).attr("xh"),o=$("#addUser"+t).find("option:checked").text(),s=$("#addUser"+t).find("option:checked").val(),f=$("#addPhone"+t).val(),l=$("#addRk"+t).val();if(isStrEmptyOrUndefined(o)){layer.msg(`序列${e}：请输入姓名`);return}if(isStrEmptyOrUndefined(s))return;if(!isStrEmptyOrUndefined(f)&&!isPhone(f)){layer.msg(`序列${e}：手机号格式不正确`);return}u.push({Name:o,Account:s,Phone:f,Remark:l})}u.length<=0||(i=null,h=function(){$("#addMaintainerBtn").attr("disabled","disabled");var n={};n.opType=c;n.opData=JSON.stringify(u);ajaxPost("/Relay/Post",n,function(n){i&&clearTimeout(i);$("#addMaintainerBtn").removeAttr("disabled");layer.msg(n.errmsg);n.errno==0&&(showMaintainerModel(0,!1),$("#addMaintainerModel").modal("hide"))});i=setTimeout(function(){$("#addMaintainerBtn").removeAttr("disabled")},5e3)},showConfirm("添加",h))}function updateMaintainer(){var i,t,n,r;if(choseMaintainer&&!(choseMaintainer.length<=0)){i=[];for(t in choseMaintainer)if(n=choseMaintainer[t],maintainers&&maintainers[t]&&(maintainers[t].Phone!=n.Phone||maintainers[t].Remark!=n.Remark)){if(!isStrEmptyOrUndefined(n.Phone)&&!isPhone(n.Phone)){layer.msg("手机号格式不正确");return}n.Account=maintainers[t].Account;n.Name=maintainers[t].Name;i.push(n)}i.length&&(r=function(){var t={},n;t.opType=431;t.opData=JSON.stringify(i);n=null;ajaxPost("/Relay/Post",t,function(t){layer.msg(t.errmsg);n&&clearTimeout(n);$("#updateMaintainerBtn").removeAttr("disabled");t.errno==0&&showMaintainerModel(0,!1)});n=setTimeout(function(){$("#delMaintainerBtn").removeAttr("disabled")},5e3)},showConfirm("保存",r))}}function delMaintainer(){var r,t,i,n,u;if(choseMaintainer&&!(choseMaintainer.length<=0)){if(r=[],t=[],choseMaintainer&&choseMaintainer.length>0){for(n in choseMaintainer)maintainers&&maintainers[n]&&t.push(n);for(i=0;i<t.length;i++)n=t[i],maintainers&&maintainers[n]&&r.push(maintainers[n].Name)}u=function(){var n,i;$("#delMaintainerBtn").attr("disabled","disabled");n={};n.opType=433;n.opData=JSON.stringify({ids:t});i=null;ajaxPost("/Relay/Post",n,function(n){layer.msg(n.errmsg);i&&clearTimeout(i);$("#delMaintainerBtn").removeAttr("disabled");n.errno==0&&showMaintainerModel(0,!1)});i=setTimeout(function(){$("#delMaintainerBtn").removeAttr("disabled")},5e3)};showConfirm("删除维修工："+r.join(","),u)}}var _permissionList=[],_priority='<option value="0">低<\/option><option value="1">中<\/option><option value="2">高<\/option>',_grade='<option value="0">小修<\/option><option value="1">大修<\/option>',_worker=null,_faultType=null,_faultTypeData=null,_faultDevData=null,_batchAssignTable=null,_serviceLogData=null,_statisticsParData=null,_siteData=null,_updateFirmwareUpload=null,_delFaultDevData=null,_delServiceLogData=null,maintainers=null,addMax=0,addMaxV=0,choseMaintainer=null,users=null;