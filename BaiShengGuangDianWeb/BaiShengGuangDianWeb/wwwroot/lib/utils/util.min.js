            ...
            <div id="innerDiv" style="position:absolute;">
                ...
                <div class="progress progress-sm active no-margin">
                    <div id="progress_box" class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="transition:all 0s">
                        ...
                        <input type="text" class="form-control text-center minute" style="width:40px" oninput="onNumberLimitInput(this)" value="${n.Min||0}"><span style="margin:0 5px">分</span>
                        <input type="text" class="form-control text-center second" style="width:40px" oninput="onNumberLimitInput(this)" value="${n.Sec||0}"><span style="margin:0 5px">秒</span>
